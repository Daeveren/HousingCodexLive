...
L["FILTER_FIRST_ACQUISITION"] = "首次获得奖励"
L["FILTER_WISHLIST_ONLY"] = "仅愿望清单"
L["FILTER_PROMO_ONLY"] = "仅促销"
L["FILTER_HIDE_SHOP_ITEMS"] = "隐藏商城物品"
L["FILTER_CURRENCY_HEADER"] = "货币"
L["FILTER_ALL_CURRENCIES"] = "所有货币"
L["FILTER_NO_CURRENCIES"] = "未找到货币"
L["FILTER_ADDED_PATCH_HEADER"] = "添加于补丁"
L["FILTER_NO_PATCHES"] = "未找到补丁版本"
L["FILTERS"] = "筛选"
L["CHECK_ALL"] = "勾选所有"
L["UNCHECK_ALL"] = "取消全选"
...
L["RESULT_COUNT_TOOLTIP_TOTAL"] = "物品总数：%d（%d 件装饰，%d 个房间）"
L["EMPTY_STATE_MESSAGE"] = "没有物品符合您的筛选条件"
L["RESET_FILTERS"] = "重置筛选"
...
L["DETAILS_ADDED_PATCH"] = "添加于补丁："
L["DETAILS_DYEABLE"] = "可染色"
L["DETAILS_NOT_DYEABLE"] = "不可染色"
L["DETAILS_SOURCE_UNKNOWN"] = "来源未知"
L["DETAILS_SOURCE_CATEGORY"] = "类别"
L["DETAILS_SOURCE_VENDOR"] = "商人"
L["DETAILS_SOURCE_ZONE"] = "区域"
L["DETAILS_SOURCE_COST"] = "花费"
L["SOURCE_PROMOTIONAL"] = "促销"
L["TOOLTIP_PROMO_DECOR"] = "促销装饰物品"
L["TILE_BADGE_PROMO"] = "促销"
L["UNKNOWN"] = "未知"
...
L["ACTION_LINK_TOOLTIP_RIGHTCLICK"] = "右键点击：复制 Wowhead 链接"
...
L["OPTIONS_SHOW_MINIMAP_TOOLTIP"] = "在小地图上显示 Housing Codex 按钮"
L["OPTIONS_VENDOR_INDICATORS"] = "在商人处标记装饰物品"
L["OPTIONS_VENDOR_INDICATORS_TOOLTIP"] = "在出售住宅装饰物品的商人处显示 Housing Codex 图标"
L["OPTIONS_VENDOR_OWNED_CHECKMARK"] = "为已拥有的装饰显示勾选标记"
L["OPTIONS_VENDOR_OWNED_CHECKMARK_TOOLTIP"] = "在您已拥有的商人装饰物品上显示绿色勾选标记"
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER"] = "筛选银月城专业商人"
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER_TOOLTIP"] = "仅显示此角色已学习专业对应的银月城专业商人"
L["OPTIONS_SECTION_CONTAINERS"] = "背包与银行"
L["OPTIONS_CONTAINER_INDICATORS"] = "标记背包与银行中的装饰物品"
L["OPTIONS_CONTAINER_INDICATORS_TOOLTIP"] = "在背包与银行中属于住宅装饰的物品上显示 Housing Codex 图标"
...
L["OPTIONS_RESET_WINDOW"] = "重置窗口"
L["OPTIONS_RESET_WINDOW_TOOLTIP"] = "重置窗口位置和大小"
L["OPTIONS_SHOW_WELCOME"] = "欢迎屏幕"
L["OPTIONS_SHOW_WELCOME_TOOLTIP"] = "显示欢迎屏幕"
L["OPTIONS_SEE_HIDDEN_ITEMS"] = "查看隐藏物品"
L["OPTIONS_SEE_HIDDEN_ITEMS_TOOLTIP"] = "查看并恢复已从 Housing Codex 列表中隐藏的物品"
L["OPTIONS_COMMAND_HELP"] = "/hc help"
L["OPTIONS_COMMAND_HELP_TOOLTIP_TITLE"] = "斜杠命令帮助"
L["OPTIONS_COMMAND_HELP_TOOLTIP_DESC"] = "在聊天窗口中输出 Housing Codex 斜杠命令帮助。可直接从设置中查看窗口和故障排除命令。"
L["SIZE_RESET"] = "窗口大小已重置为默认值。"

L["OPTIONS_SECTION_KEYBIND"] = "按键绑定"
L["OPTIONS_SECTION_TROUBLESHOOTING"] = "故障排除与调试"
L["OPTIONS_DISABLE_CUSTOM_FONT"] = "禁用自定义字体"
L["OPTIONS_ENABLE_CUSTOM_FONT"] = "启用自定义字体"
...
L["OPTIONS_KEYBIND_CONFLICT"] = "\"%s\" 已被绑定到 \"%s\"。\n\n是否要将其重新分配给 Housing Codex？"

--------------------------------------------------------------------------------
-- Slash Command Help
--------------------------------------------------------------------------------
L["HELP_TITLE"] = "Housing Codex 命令："
L["HELP_ALIASES"] = "别名：/hcodex、/housingcodex"
L["HELP_TOGGLE"] = "/hc - 切换主窗口"
L["HELP_SETTINGS"] = "/hc settings/options - 打开设置"
L["HELP_RESET"] = "/hc reset - 重置窗口位置"
L["HELP_RETRY"] = "/hc retry/reload - 重试加载数据"
L["HELP_HELP"] = "/hc help/? - 显示此帮助"
L["HELP_DEBUG"] = "/hc debug - 切换调试模式"
L["HELP_STATS"] = "/hc stats - 显示调试计数器"
L["HELP_STATS_RESET"] = "/hc stats reset - 重置调试计数器"
L["HELP_LOG"] = "|cFFFFD100/hc log|r - 显示事件追踪日志（需要调试模式）"
L["HELP_LOG_CLEAR"] = "|cFFFFD100/hc log clear|r - 清除事件追踪日志"
L["HELP_FONT"] = "/hc font - 切换 Housing Codex 自定义字体"
L["HELP_WELCOME"] = "/hc welcome - 显示欢迎屏幕"
L["HELP_WHATSNEW"] = "/hc whatsnew - 显示最新更改"
L["HELP_INSPECT"] = "/hc inspect <名称> - 检查装饰记录以进行调试"
...
L["EVENT_TRACE_LOG_CLEARED"] = "事件追踪日志已清除"
...
L["INSPECT_NOT_FOUND"] = "未找到与 %s 匹配的物品"
...
L["ACHIEVEMENTS_TRACKING_MAX_REACHED"] = "无法追踪 - 已达到最大成就数量（10）"
...
L["CONTEXT_MENU_HIDE_ITEM"] = "隐藏此物品"
L["CONTEXT_MENU_UNHIDE_ITEM"] = "取消隐藏此物品"
L["HIDDEN_ITEMS_TITLE"] = "隐藏物品"
L["HIDDEN_ITEMS_EMPTY"] = "没有隐藏物品"
L["HIDDEN_ITEMS_EMPTY_DESC"] = "右键点击 Housing Codex 中的物品并选择隐藏此物品，即可将其添加到这里。"
L["HIDDEN_ITEMS_UNHIDE"] = "取消隐藏"
L["HIDDEN_ITEMS_CLEAR_ALL"] = "全部取消隐藏"
L["HIDDEN_ITEMS_CLEAR_ALL_TOOLTIP"] = "恢复所有通过隐藏此物品隐藏的物品"
L["HIDDEN_ITEMS_CLEAR_ALL_CONFIRM"] = "要取消隐藏全部 %d 个物品吗？"
L["HIDDEN_ITEMS_HIDE_CONFIRM"] = "要隐藏“%s”吗？"
L["HIDDEN_ITEMS_COUNT"] = "已隐藏 %d 个"

--------------------------------------------------------------------------------
-- Vendors Tab
--------------------------------------------------------------------------------
L["VENDORS_SEARCH_PLACEHOLDER"] = "搜索商人、区域、货币或物品..."
L["VENDORS_FILTER_ALL"] = "全部"
L["VENDORS_FILTER_INCOMPLETE"] = "未完成"
L["VENDORS_FILTER_COMPLETE"] = "已完成"
L["VENDORS_FILTER_CURRENCY"] = "货币"
L["VENDORS_FILTER_ALL_CURRENCIES"] = "所有货币"
L["VENDORS_FILTER_NO_CURRENCIES"] = "未找到货币"
...
L["VENDORS_EMPTY_NO_RESULTS"] = "没有商人符合您的筛选条件"
...
L["VENDOR_PIN_PROMO"] = "促销：%d/%d"
L["VENDOR_PIN_UNCOLLECTED_HEADER"] = "未收集的装饰："
L["VENDOR_PIN_ITEM_PROMO"] = "促销"
L["VENDOR_PIN_ITEM_LOCKED"] = "已锁定"
L["VENDOR_PIN_MORE"] = "另外 %d 项"
...
L["VENDOR_PIN_VENDOR_ENTRY_PROMO_ONLY"] = "%s（促销：%d/%d）"
L["VENDOR_PIN_VENDORS_MORE"] = "另外 %d 个商人"
...
L["VENDOR_CLASS_HALL_SUFFIX"] = "%s 职业大厅"
L["VENDOR_HOUSING_ZONE_SUFFIX"] = "住宅区域：%s"
L["VENDOR_CLASS_ONLY_SUFFIX"] = "仅 %s"

-- Vendor tooltip overlay
L["OPTIONS_VENDOR_TOOLTIPS"] = "在提示信息中显示住宅装饰物品"
L["OPTIONS_VENDOR_TOOLTIPS_TOOLTIP"] = "鼠标悬停于装饰商人 NPC 时，显示 Housing Codex 收集进度"
...
--------------------------------------------------------------------------------
L["TREASURE_HUNT_WAYPOINT_TITLE"] = "装饰宝藏"
...
L["PROGRESS_RENOWN_EXPANSIONS"] = "声望（按资料片）"
L["PROGRESS_PVP_CATEGORIES"] = "PvP 分类"
L["PROGRESS_PROFESSIONS"] = "专业"
L["PROGRESS_ALMOST_THERE"] = "进度最高"
L["PROGRESS_OVERVIEW"] = "进度概览"
L["PROGRESS_ALL_DECOR_COLLECTED"] = "已收集可见装饰"
...
L["PROGRESS_SOURCE_RENOWN"] = "声望"
L["PROGRESS_SOURCE_PROMOTIONAL"] = "促销"
L["PROGRESS_LOADING"] = "加载进度数据中..."

L["WISHLIST_SEARCH_PLACEHOLDER"] = "搜索愿望清单..."
L["WISHLIST_NO_SEARCH_RESULTS"] = "没有符合搜索的愿望清单物品"
L["WISHLIST_NO_SEARCH_RESULTS_DESC"] = "尝试其他物品名称，或清空搜索框。"
L["WISHLIST_GROUP_BY_SOURCE"] = "按来源分组"
L["WISHLIST_GROUP_OTHER"] = "其他"
L["WISHLIST_GROUP_HEADER_COUNT"] = "共 %d，已收集 %d"
L["PROGRESS_STAT_WISHLIST"] = "愿望清单"
L["PROGRESS_STAT_HIDDEN"] = "已隐藏"
L["PROGRESS_BUDGET_HEADER"] = "地块装饰预算"
L["PROGRESS_BUDGET_INTERIOR"] = "室内"
L["PROGRESS_BUDGET_PLOT"] = "地块"
L["PROGRESS_BUDGET_LAST_UPDATED"] = "上次更新：%s"
L["PROGRESS_BUDGET_OUTDOOR"] = "室外"
L["PROGRESS_BUDGET_EMPTY_HINT"] = "拜访此房屋地块，并在室外和室内进入编辑房屋模式以记录两个预算值。"
L["PROGRESS_BUDGET_REFRESH_BOTH_HINT"] = "两个预算值都需要重新验证。请在这栋房屋的室外和室内分别进入房屋编辑模式。"
L["PROGRESS_BUDGET_REFRESH_OUTDOOR_HINT"] = "室外预算需要重新验证。请在此地块的室外进入房屋编辑模式。"
L["PROGRESS_BUDGET_REFRESH_INTERIOR_HINT"] = "室内预算需要重新验证。请在这栋房屋内进入房屋编辑模式。"
L["PROGRESS_BUDGET_INDOOR"] = "室内"
L["PROGRESS_BUDGET_LEVEL"] = "等级：%d"
L["PROGRESS_BUDGET_LEVEL_UNKNOWN"] = "等级：--"
L["PROGRESS_BUDGET_TIME_AGO"] = "%s前"
L["PROGRESS_TIME_MINUTE"] = "%d分钟"
L["PROGRESS_TIME_MINUTES"] = "%d分钟"
L["PROGRESS_TIME_HOUR"] = "%d小时"
L["PROGRESS_TIME_HOURS"] = "%d小时"
L["PROGRESS_TIME_DAY"] = "%d天"
L["PROGRESS_TIME_DAYS"] = "%d天"
L["PROGRESS_HISTORY_HEADER"] = "最近 %d 天的装饰"
L["PROGRESS_HISTORY_SUMMARY"] = "+%d，最近 %d 天"
L["PROGRESS_HISTORY_TOOLTIP_TODAY"] = "今天"
L["PROGRESS_HISTORY_TOOLTIP_DAY_AGO"] = "%d天前"
L["PROGRESS_HISTORY_TOOLTIP_DAYS_AGO"] = "%d天前"
L["PROGRESS_HISTORY_TOOLTIP_GAIN"] = "+%d 个装饰已学习"
L["PROGRESS_HISTORY_TOOLTIP_EMPTY"] = "没有记录新的装饰"
L["PROGRESS_HISTORY_TOOLTIP_START"] = "当天开始：%s"
L["PROGRESS_HISTORY_TOOLTIP_TOTAL"] = "记录总数：%s"
L["PROGRESS_HISTORY_TOOLTIP_NO_SNAPSHOT"] = "这一天没有保存快照"
L["PROGRESS_HISTORY_TOOLTIP_HINT"] = "当已收集装饰数量变化时更新。"
L["PROGRESS_ACHIEVEMENT_CATEGORIES"] = "成就类别"
L["PROGRESS_DROP_CATEGORIES"] = "掉落类别"
--------------------------------------------------------------------------------
...
L["ZONE_OVERLAY_CLICK_OPEN_HC"] = "右键点击在 Housing Codex 中打开"
...
-- What's New Popup
--------------------------------------------------------------------------------
L["WHATSNEW_TITLE"] = "Housing Codex 新功能"
L["WHATSNEW_DONT_SHOW"] = "不再为此版本（v%s）显示"
L["WHATSNEW_EXPLORE"] = "探索 Housing Codex"

--------------------------------------------------------------------------------
-- Welcome Popup
--------------------------------------------------------------------------------
L["WELCOME_TITLE"] = "欢迎使用 Housing Codex"
L["WELCOME_SUBTITLE"] = "您发现装饰物品和管理住宅的好帮手"
L["WELCOME_START"] = "开始探索"
L["WELCOME_QUICK_SETUP"] = "温馨提示"
L["WELCOME_OPEN_INSTRUCTION"] = "您可以随时输入 %s，或按下您在 %s 中设置的按键来打开插件。"
L["WELCOME_KEYBIND_LABEL"] = "选项"
...
L["WELCOME_F3_DESC"] = "查看如何获取缺失的装饰：任务、成就、商人、掉落、专业、声望和 PvP。"
L["WELCOME_F4_TITLE"] = "商人标识"
L["WELCOME_F4_DESC"] = "商人、背包与银行界面显示装饰图标，使可收集物品一目了然。"
L["WELCOME_F5_TITLE"] = "地图整合"
L["WELCOME_F5_DESC"] = "地图标记显示装饰商人的位置，区域覆盖指引您找到缺失的装饰。"
L["WELCOME_F6_TITLE"] = "收集进度"
L["WELCOME_F6_DESC"] = "进度标签页按来源和资料片汇总收藏状态，并显示最接近完成的类别。"

--------------------------------------------------------------------------------
-- Endeavors Panel
--------------------------------------------------------------------------------
L["ENDEAVORS_TITLE"] = "睦邻活动"
L["ENDEAVORS_BAR_ABBREV"] = "睦"
L["ENDEAVORS_OPTIONS"] = "睦邻活动选项"
L["ENDEAVORS_OPTIONS_TOOLTIP"] = "配置睦邻活动覆盖面板"
...
L["ENDEAVORS_OPT_SECTION_HOUSE_XP"] = "住宅经验"
L["ENDEAVORS_OPT_SECTION_ENDEAVOR"] = "睦邻活动进度"
L["ENDEAVORS_OPT_SECTION_SIZE"]     = "面板大小"
L["ENDEAVORS_OPT_SHOW_HOUSE_XP"] = "显示住宅经验条"
L["ENDEAVORS_OPT_SHOW_HOUSE_XP_TIP"] = "显示住宅等级与经验进度条"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR"] = "显示睦邻活动进度条"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TIP"] = "显示睦邻活动进度条"
L["ENDEAVORS_OPT_SHOW_XP_TEXT"] = "显示经验条数值"
L["ENDEAVORS_OPT_SHOW_XP_TEXT_TIP"] = "在住宅经验条上显示具体数值"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT"] = "显示睦邻活动条数值"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT_TIP"] = "在睦邻活动进度条上显示具体数值"
L["ENDEAVORS_OPT_SHOW_XP_PCT"] = "显示经验条百分比"
L["ENDEAVORS_OPT_SHOW_XP_PCT_TIP"] = "在住宅经验条上显示百分比"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT"] = "显示睦邻活动条百分比"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT_TIP"] = "在睦邻活动进度条上显示百分比"
...
L["ENDEAVORS_XP_TOOLTIP_AVAILABLE"] = "可领取：%s"
L["ENDEAVORS_XP_TOOLTIP_CLICK"] = "点击打开住宅控制台"
L["ENDEAVORS_TOOLTIP_CLICK"] = "点击打开睦邻活动"
L["ENDEAVORS_PCT_DONE"] = "已完成"
L["OPTIONS_SECTION_ENDEAVORS"] = "睦邻活动"
L["OPTIONS_ENDEAVORS_ENABLED"] = "启用睦邻活动面板"
L["OPTIONS_ENDEAVORS_ENABLED_TOOLTIP"] = "当身处拥有住宅的社区时，显示睦邻活动迷你面板"
L["ENDEAVORS_OPT_ENABLED"] = "启用睦邻活动面板"
L["ENDEAVORS_OPT_ENABLED_TIP"] = "当身处拥有住宅的社区时，显示睦邻活动面板"
...
L["ENDEAVORS_OPT_SCALE_TIP"] = "调整睦邻活动面板的尺寸"
...
L["RENOWN_STANDING_GOOD_FRIEND"] = "好朋友"
L["RENOWN_FACTION_UNKNOWN_FORMAT"] = "阵营 #%d"
...
SN["Arcanostorage Sphere"] = "奥术秘藏光球"
SN["BlizzCon 2026 Twitch / YouTube reward (4 hours; claim to unlock extra copies)"] = "BlizzCon 2026 Twitch/YouTube 奖励（观看4小时；领取后解锁额外数量）"
SN["BlizzCon 2026 in-game goodies"] = "BlizzCon 2026游戏内福利"
SN["Brewfest (seasonal event)"] = "美酒节（节日活动）"
SN["Darkshore Rares"] = "黑海岸稀有精英"
SN["Delve Treasure Chests"] = "地下堡宝箱"
SN["Delves"] = "地下堡"
SN["Diablo 2 expansion bonus"] = "Diablo 2 资料片附赠奖励"
SN["Diablo 4 pre-order"] = "Diablo 4 预购奖励"
SN["Fanta x Warcraft collab"] = "Fanta与魔兽世界联动"
SN["Highmountain Tauren Paragon Chest"] = "至高岭牛头人巅峰宝箱"
SN["In-game shop"] = "游戏内商城"
SN["Large Starter Decor Pack"] = "大型入门装饰礼包"
SN["Login Reward (Midnight)"] = "登录奖励（至暗之夜）"
SN["Lush Garden Decor Pack"] = "葱郁花园装饰礼包"
SN["Lush Garden Decor Pack 2"] = "葱郁花园装饰礼包2"
SN["Midnight Delves"] = "至暗之夜地下堡"
SN["Pepe (neighborhood billboard)"] = "Pepe（社区广告牌）"
SN["Pinterest London IRL quest (March 21)"] = "Pinterest 伦敦线下任务（3月21日）"
SN["Ral'kala"] = "拉尔卡拉"
SN["Roofus charity pet (The Roofus Pack)"] = "鲁弗斯慈善宠物（鲁弗斯礼包）"
SN["Rotmire"] = "腐沼"
SN["Self-Assembling Homeware Kit (Mechagon)"] = "自组装家居套件（麦卡贡）"
SN["Shadowmoon Valley (Draenor) Missives"] = "影月谷（德拉诺）密文"
SN["Shop"] = "商城"
SN["Small Starter Decor Pack"] = "小型入门装饰礼包"
SN["Spring Blossom Decor Pack"] = "春芳花装饰礼包"
SN["Spring Blossom Decor Pack 2"] = "春芳花装饰礼包2"
SN["Strange Recycling Requisition (Mechagon)"] = "奇怪的回收申请单（麦卡贡）"
SN["Theater Troupe event chest (Isle of Dorn)"] = "剧场巡演宝箱（多恩岛）"
SN["Twitch Drop"] = "Twitch掉落"
SN["Twitch drop (Feb 26 to Mar 24)"] = "Twitch掉落（2月26日至3月24日）"
SN["Twitch drop (June 16 to July 14)"] = "Twitch掉落（6月16日至7月14日）"
SN["Undermine Jobs"] = "安德麦任务"
SN["Victorious Stormarion Cache"] = "胜利的风暴者宝箱"
SN["Zillow & Warcraft collab"] = "Zillow与魔兽世界联动"
SN["Zillow for Warcraft Promotion"] = "魔兽版Zillow推广活动"

-- Encounters (bosses)
SN["Advisor Melandrus (Court of Stars)"] = "顾问麦兰杜斯（群星庭院）"
SN["Avatar of Sethraliss (Temple of Sethraliss)"] = "塞塔里斯的化身（塞塔里斯神庙）"
...
SN["Dazar, The First King (Kings' Rest)"] = "初代国王达萨（诸王之眠）"
...
SN["Entombed Sentinels (The Venomous Abyss)"] = "陵寝哨兵（烈毒之渊）"
...
SN["Nalorakk"] = "纳洛拉克"
SN["Nek'zali the Soulcoiler (The Venomous Abyss)"] = "盘魂者内克扎莉（烈毒之渊）"
SN["Nymrissa Wavecaller (The Tidebound Grotto)"] = "尼姆瑞莎·唤波者（潮缚石窟）"
...
SN["Sszorak (The Venomous Abyss)"] = "斯索拉克（烈毒之渊）"
SN["Teron'gor"] = "塔隆戈尔"
SN["The Coiled Altar (The Venomous Abyss)"] = "盘卷祭坛（烈毒之渊）"
SN["The Darkness"] = "黑暗之主"
SN["The Lost Explorers (The Venomous Abyss)"] = "迷失的探险者（烈毒之渊）"
SN["The Restless Cabal"] = "无眠秘党"
SN["The Restless Heart"] = "无眠之心"
SN["The Twin Fangs (The Venomous Abyss)"] = "双子毒牙（烈毒之渊）"
SN["Ula'tek (Heroic, The Venomous Abyss)"] = "乌拉特克（英雄难度，烈毒之渊）"
SN["Ula'tek (Mythic, The Venomous Abyss)"] = "乌拉特克（史诗难度，烈毒之渊）"
SN["Ula'tek (Raid Finder/Normal, The Venomous Abyss)"] = "乌拉特克（随机团队/普通难度，烈毒之渊）"
SN["Ula'tek (The Venomous Abyss)"] = "乌拉特克（烈毒之渊）"
SN["Vaelgor & Ezzorak"] = "威厄高尔与艾佐拉克"
SN["Vanessa VanCleef"] = "梵妮莎·范克里夫"
SN["Vashnik the Malignant (The Venomous Abyss)"] = "万毒邪祟者瓦什尼克（烈毒之渊）"
...
-- Treasures
SN["Crumbling Urn (The Coiled Isle)"] = "破碎的骨灰瓮（盘卷蛇岛）"
SN["Forgotten Treasure (The Coiled Isle)"] = "被遗忘的宝藏（盘卷蛇岛）"
SN["Glimmering Treasure Chest"] = "闪闪发光的宝箱"
...
SN["Stinking Vessel (The Coiled Isle)"] = "恶臭的容器（盘卷蛇岛）"
SN["Stone Vat (Eversong Woods)"] = "石缸（永歌森林）"
SN["Undermine"] = "安德麦"
SN["Venomjade Necklace (The Coiled Isle)"] = "毒翡翠项链（盘卷蛇岛）"
SN["Zul'jan's Strongbox (Altar of Fangs)"] = "祖尔加的保险箱（毒牙祭坛）"

-- Recipe sources (Professions tab)
SN["Construct V'anore"] = "构造体瓦诺雷"
SN["Jan'sari the Watchful"] = "警惕的詹萨莉"
SN["Navigator Otoola"] = "领航员奥图拉"
SN["Second Mate Sluggs"] = "二副斯拉格斯"
SN["Thalassian Recipe in a Bottle"] = "萨拉斯瓶中配方"
...
SN["BlizzCon 2026 login reward (September 12-27)"] = "BlizzCon 2026登录奖励（9月12日至27日）"
SN["World of Warcraft: Forever - Skyborne packs"] = "World of Warcraft: Forever - Skyborne礼包"
SN["Warcraft Forever Collection / Collector's Edition"] = "Warcraft Forever Collection / 典藏版"
