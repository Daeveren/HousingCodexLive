...
L["OPTIONS_LDB_UNIQUE"] = "显示独特收集数"
L["OPTIONS_LDB_UNIQUE_TOOLTIP"] = "在小地图信息栏文本中显示独特收集数量"
L["OPTIONS_LDB_TOTAL_OWNED"] = "显示拥有总数"
L["OPTIONS_LDB_TOTAL_OWNED_TOOLTIP"] = "在小地图信息栏文本中显示拥有总数（包括重复）"
L["OPTIONS_LDB_TOTAL"] = "显示物品总数"
L["OPTIONS_LDB_TOTAL_TOOLTIP"] = "在小地图信息栏文本中显示装饰物品总数"
...
L["LDB_TOOLTIP_DECOR_HEADER"] = "装饰物品"
