...
L["RESULT_COUNT_TOOLTIP_UNIQUE"] = "独特收集: %d"
L["RESULT_COUNT_TOOLTIP_OWNED"] = "拥有总数: %d"
L["RESULT_COUNT_TOOLTIP_TOTAL"] = "装饰总数: %d"
...
L["OPTIONS_SECTION_MERCHANT"] = "商人"
L["OPTIONS_SHOW_COLLECTED"] = "在格子上显示拥有数量"
L["OPTIONS_SHOW_COLLECTED_TOOLTIP"] = "在网格格子上显示已收集物品的拥有数量"
...
L["OPTIONS_SHOW_WELCOME_TOOLTIP_DISABLED"] = "使用 /hc welcome 显示欢迎屏幕"
...
L["LDB_POPUP_UNIQUE"] = "独特收集"
L["LDB_POPUP_TOTAL_OWNED"] = "拥有总数"
...
L["ENDEAVORS_COUPONS_EARNED"] = "本次家园任务已获得 %d/%d %s"
