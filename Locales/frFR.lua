...
L["OPTIONS_LDB_UNIQUE"] = "Afficher les uniques collectés"
L["OPTIONS_LDB_UNIQUE_TOOLTIP"] = "Afficher le nombre d'uniques collectés dans le texte du broker minicarte"
L["OPTIONS_LDB_TOTAL_OWNED"] = "Afficher le total possédé"
L["OPTIONS_LDB_TOTAL_OWNED_TOOLTIP"] = "Afficher le total possédé (avec doublons) dans le texte du broker minicarte"
L["OPTIONS_LDB_TOTAL"] = "Afficher le total des objets"
L["OPTIONS_LDB_TOTAL_TOOLTIP"] = "Afficher le nombre total de décors dans le texte du broker minicarte"
...
L["LDB_TOOLTIP_DECOR_HEADER"] = "Objets de décor"
