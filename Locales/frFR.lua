...
L["FILTER_PROMO_ONLY"] = "Promo uniquement"
L["FILTER_HIDE_SHOP_ITEMS"] = "Masquer les objets de la boutique"
L["FILTER_CURRENCY_HEADER"] = "Monnaie"
L["FILTER_ALL_CURRENCIES"] = "Toutes les monnaies"
L["FILTER_NO_CURRENCIES"] = "Aucune monnaie trouvée"
L["FILTER_ADDED_PATCH_HEADER"] = "Ajouté au patch"
L["FILTER_NO_PATCHES"] = "Aucune version de patch trouvée"
L["FILTERS"] = "Filtres"
...
L["DETAILS_ADDED_PATCH"] = "Ajouté au patch :"
L["DETAILS_DYEABLE"] = "Teignable"
L["DETAILS_NOT_DYEABLE"] = "Non teignable"
L["DETAILS_SOURCE_UNKNOWN"] = "Source inconnue"
L["DETAILS_SOURCE_CATEGORY"] = "Catégorie"
L["DETAILS_SOURCE_VENDOR"] = "Vendeur"
L["DETAILS_SOURCE_ZONE"] = "Zone"
L["DETAILS_SOURCE_COST"] = "Coût"
L["SOURCE_PROMOTIONAL"] = "Promotionnel"
L["TOOLTIP_PROMO_DECOR"] = "Objet de décor promotionnel"
...
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER"] = "Filtrer les vendeurs de métiers de Lune-d'argent"
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER_TOOLTIP"] = "Afficher uniquement les vendeurs de métiers de Lune-d'argent pour les métiers appris par ce personnage"
...
L["OPTIONS_RESET_WINDOW"] = "Réinitialiser la fenêtre"
L["OPTIONS_RESET_WINDOW_TOOLTIP"] = "Réinitialiser la position et la taille de la fenêtre"
L["OPTIONS_SHOW_WELCOME"] = "Écran d'accueil"
L["OPTIONS_SHOW_WELCOME_TOOLTIP"] = "Afficher l'écran d'accueil"
L["OPTIONS_SEE_HIDDEN_ITEMS"] = "Voir les objets masqués"
L["OPTIONS_SEE_HIDDEN_ITEMS_TOOLTIP"] = "Afficher et restaurer les objets masqués dans les listes de Housing Codex"
L["OPTIONS_COMMAND_HELP"] = "/hc help"
L["OPTIONS_COMMAND_HELP_TOOLTIP_TITLE"] = "Aide des commandes"
L["OPTIONS_COMMAND_HELP_TOOLTIP_DESC"] = "Affiche l'aide des commandes slash de Housing Codex dans la fenêtre de discussion. Utilisez-la pour retrouver les commandes de fenêtre ou de dépannage depuis les options."
L["SIZE_RESET"] = "Taille de la fenêtre réinitialisée."

L["OPTIONS_SECTION_KEYBIND"] = "Raccourci"
L["OPTIONS_SECTION_TROUBLESHOOTING"] = "Dépannage et débogage"
L["OPTIONS_DISABLE_CUSTOM_FONT"] = "Désactiver la police personnalisée"
L["OPTIONS_ENABLE_CUSTOM_FONT"] = "Activer la police personnalisée"
...
L["HELP_ALIASES"] = "Alias : /hcodex, /housingcodex"
L["HELP_TOGGLE"] = "/hc - Afficher/masquer la fenêtre"
L["HELP_SETTINGS"] = "/hc settings/options - Ouvrir les options"
L["HELP_RESET"] = "/hc reset - Réinitialiser la position"
L["HELP_RETRY"] = "/hc retry/reload - Réessayer le chargement"
...
L["HELP_STATS_RESET"] = "/hc stats reset - Réinitialiser les compteurs de débogage"
L["HELP_LOG"] = "|cFFFFD100/hc log|r - Afficher le journal des événements (mode débogage requis)"
L["HELP_LOG_CLEAR"] = "|cFFFFD100/hc log clear|r - Effacer le journal des événements"
L["HELP_FONT"] = "/hc font - Activer/désactiver la police personnalisée de Housing Codex"
L["HELP_WELCOME"] = "/hc welcome - Afficher l'écran d'accueil"
L["HELP_WHATSNEW"] = "/hc whatsnew - Afficher les dernières nouveautés"
L["HELP_INSPECT"] = "/hc inspect <nom> - Inspecter un décor pour le débogage"
...
L["EVENT_TRACE_LOG_CLEARED"] = "Journal des événements effacé"
...
L["CONTEXT_MENU_HIDE_ITEM"] = "Masquer cet objet"
L["CONTEXT_MENU_UNHIDE_ITEM"] = "Réafficher cet objet"
L["HIDDEN_ITEMS_TITLE"] = "Objets masqués"
L["HIDDEN_ITEMS_EMPTY"] = "Aucun objet masqué"
L["HIDDEN_ITEMS_EMPTY_DESC"] = "Faites un clic droit sur un objet dans Housing Codex et choisissez Masquer cet objet pour l'ajouter ici."
L["HIDDEN_ITEMS_UNHIDE"] = "Réafficher"
L["HIDDEN_ITEMS_CLEAR_ALL"] = "Tout réafficher"
L["HIDDEN_ITEMS_CLEAR_ALL_TOOLTIP"] = "Restaurer tous les objets masqués avec Masquer cet objet"
L["HIDDEN_ITEMS_CLEAR_ALL_CONFIRM"] = "Réafficher les %d objets masqués ?"
L["HIDDEN_ITEMS_HIDE_CONFIRM"] = "Masquer « %s » ?"
L["HIDDEN_ITEMS_COUNT"] = "%d masqué(s)"

--------------------------------------------------------------------------------
-- Vendors Tab
--------------------------------------------------------------------------------
L["VENDORS_SEARCH_PLACEHOLDER"] = "Rechercher des marchands, zones, monnaies ou objets..."
L["VENDORS_FILTER_ALL"] = "Tous"
L["VENDORS_FILTER_INCOMPLETE"] = "Incomplets"
L["VENDORS_FILTER_COMPLETE"] = "Complétés"
L["VENDORS_FILTER_CURRENCY"] = "Monnaie"
L["VENDORS_FILTER_ALL_CURRENCIES"] = "Toutes les monnaies"
L["VENDORS_FILTER_NO_CURRENCIES"] = "Aucune monnaie trouvée"
...
L["VENDORS_EMPTY_NO_RESULTS"] = "Aucun marchand ne correspond à vos filtres"
...
-- Vendor cost display
L["CURRENCY_GOLD"] = "or"
L["CURRENCY_GOLD_FORMAT"] = "%s |4pièce d’or:pièces d’or;"
...
L["VENDOR_CLASS_HALL_SUFFIX"] = "fief de classe : %s"
L["VENDOR_HOUSING_ZONE_SUFFIX"] = "zone de logement : %s"
...
--------------------------------------------------------------------------------
L["TREASURE_HUNT_WAYPOINT_TITLE"] = "Trésor de décor"
...
L["PROGRESS_SOURCE_PROMOTIONAL"] = "Promotionnel"
L["PROGRESS_LOADING"] = "Chargement des données de progression..."

L["WISHLIST_SEARCH_PLACEHOLDER"] = "Rechercher dans la liste..."
L["WISHLIST_NO_SEARCH_RESULTS"] = "Aucun objet de la liste ne correspond"
L["WISHLIST_NO_SEARCH_RESULTS_DESC"] = "Essayez un autre nom ou effacez la recherche."
L["WISHLIST_GROUP_BY_SOURCE"] = "Grouper par source"
L["WISHLIST_GROUP_OTHER"] = "Autre"
L["WISHLIST_GROUP_HEADER_COUNT"] = "%d au total, %d collectés"
L["PROGRESS_STAT_WISHLIST"] = "Liste de souhaits"
L["PROGRESS_STAT_HIDDEN"] = "Masqués"
L["PROGRESS_BUDGET_HEADER"] = "BUDGET DÉCOR PARCELLE"
L["PROGRESS_BUDGET_INTERIOR"] = "Intérieur"
L["PROGRESS_BUDGET_PLOT"] = "Terrain"
L["PROGRESS_BUDGET_LAST_UPDATED"] = "Dernière mise à jour : %s"
L["PROGRESS_BUDGET_OUTDOOR"] = "Extérieur"
L["PROGRESS_BUDGET_EMPTY_HINT"] = "Visitez ce terrain et passez en mode modification de maison dehors et dedans pour enregistrer les deux budgets."
L["PROGRESS_BUDGET_REFRESH_BOTH_HINT"] = "Les deux budgets doivent être vérifiés à nouveau. Passez en mode modification de maison à l’extérieur puis à l’intérieur de cette maison."
L["PROGRESS_BUDGET_REFRESH_OUTDOOR_HINT"] = "Le budget extérieur doit être vérifié à nouveau. Passez en mode modification de maison à l’extérieur sur ce terrain."
L["PROGRESS_BUDGET_REFRESH_INTERIOR_HINT"] = "Le budget intérieur doit être vérifié à nouveau. Passez en mode modification de maison à l’intérieur de cette maison."
L["PROGRESS_BUDGET_INDOOR"] = "Intérieur"
L["PROGRESS_BUDGET_LEVEL"] = "Niveau %d"
L["PROGRESS_BUDGET_LEVEL_UNKNOWN"] = "Niveau --"
L["PROGRESS_BUDGET_TIME_AGO"] = "il y a %s"
L["PROGRESS_TIME_MINUTE"] = "%d minute"
L["PROGRESS_TIME_MINUTES"] = "%d minutes"
L["PROGRESS_TIME_HOUR"] = "%d heure"
L["PROGRESS_TIME_HOURS"] = "%d heures"
L["PROGRESS_TIME_DAY"] = "%d jour"
L["PROGRESS_TIME_DAYS"] = "%d jours"
L["PROGRESS_HISTORY_HEADER"] = "DÉCOR DES %d DERNIERS JOURS"
L["PROGRESS_HISTORY_SUMMARY"] = "+%d ces %d derniers jours"
L["PROGRESS_HISTORY_TOOLTIP_TODAY"] = "Aujourd'hui"
L["PROGRESS_HISTORY_TOOLTIP_DAY_AGO"] = "Il y a %d jour"
L["PROGRESS_HISTORY_TOOLTIP_DAYS_AGO"] = "Il y a %d jours"
L["PROGRESS_HISTORY_TOOLTIP_GAIN"] = "+%d décor appris"
L["PROGRESS_HISTORY_TOOLTIP_EMPTY"] = "Aucun nouveau décor enregistré"
L["PROGRESS_HISTORY_TOOLTIP_START"] = "Début du jour : %s"
L["PROGRESS_HISTORY_TOOLTIP_TOTAL"] = "Total enregistré : %s"
L["PROGRESS_HISTORY_TOOLTIP_NO_SNAPSHOT"] = "Aucun instantané enregistré pour ce jour"
L["PROGRESS_HISTORY_TOOLTIP_HINT"] = "Se met à jour quand votre total de décors collectés change."
L["PROGRESS_ACHIEVEMENT_CATEGORIES"] = "Catégories de hauts faits"
L["PROGRESS_DROP_CATEGORIES"] = "Catégories de butin"
--------------------------------------------------------------------------------
...
L["WELCOME_OPEN_INSTRUCTION"] = "Vous pouvez ouvrir l’addon à tout moment avec %s ou définir votre propre raccourci dans %s."
...
L["WELCOME_F3_DESC"] = "Découvrez où obtenir les décors manquants : quêtes, hauts faits, marchands, butins, métiers, renom et JcJ."
...
-- Endeavors Panel
--------------------------------------------------------------------------------
L["ENDEAVORS_TITLE"] = "Initiatives"
L["ENDEAVORS_BAR_ABBREV"] = "I"
L["ENDEAVORS_OPTIONS"] = "Options des initiatives"
L["ENDEAVORS_OPTIONS_TOOLTIP"] = "Configurer le panneau des initiatives"
...
L["ENDEAVORS_OPT_SECTION_ENDEAVOR"] = "Progression de l’initiative"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR"] = "Afficher la barre de progression de l’initiative"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TIP"] = "Afficher la barre de progression de l’initiative du voisinage"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT"] = "Afficher le texte de la barre de l’initiative"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT_TIP"] = "Afficher les valeurs numériques sur la barre de progression de l’initiative"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT"] = "Afficher le pourcentage de l’initiative"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT_TIP"] = "Afficher le pourcentage sur la barre de progression de l’initiative"
...
L["ENDEAVORS_XP_TOOLTIP_AVAILABLE"] = "Disponible : %s"
L["ENDEAVORS_XP_TOOLTIP_CLICK"] = "Cliquez pour ouvrir le tableau de bord de logement"
L["ENDEAVORS_TOOLTIP_CLICK"] = "Cliquez pour ouvrir les initiatives"
L["ENDEAVORS_PCT_DONE"] = "TERMINÉ"
L["OPTIONS_SECTION_ENDEAVORS"] = "Initiatives"
L["OPTIONS_ENDEAVORS_ENABLED"] = "Activer le panneau des initiatives"
L["OPTIONS_ENDEAVORS_ENABLED_TOOLTIP"] = "Afficher le mini-panneau des initiatives dans un voisinage avec une maison"
L["ENDEAVORS_OPT_ENABLED"] = "Activer le panneau des initiatives"
L["ENDEAVORS_OPT_ENABLED_TIP"] = "Afficher le panneau des initiatives dans un voisinage avec une maison"
L["ENDEAVORS_COMPLETED_TIMES"] = "Accomplie %d |4fois:fois;"
L["ENDEAVORS_TIME_DAYS_LEFT"] = "%d |4jour restant:jours restants;"
L["ENDEAVORS_TIME_HOURS_LEFT"] = "%d |4heure restante:heures restantes;"
L["ENDEAVORS_COUPONS_EARNED"] = "%s: %d/%d"
L["ENDEAVORS_OPT_SCALE"] = "Taille du panneau"
L["ENDEAVORS_OPT_SCALE_TIP"] = "Modifier la taille du panneau des initiatives"
...
L["RENOWN_STANDING_GOOD_FRIEND"] = "Bon ami"
L["RENOWN_FACTION_UNKNOWN_FORMAT"] = "Faction n°%d"
...
SN["Arcanostorage Sphere"] = "Sphère de stockage arcanique"
SN["BlizzCon 2026 Twitch / YouTube reward (4 hours; claim to unlock extra copies)"] = "Récompense de visionnage Twitch / YouTube de la BlizzCon 2026 (4 heures ; à récupérer pour débloquer des exemplaires supplémentaires)"
SN["BlizzCon 2026 in-game goodies"] = "Bonus en jeu de la BlizzCon 2026"
SN["Brewfest (seasonal event)"] = "Fête des Brasseurs (événement saisonnier)"
SN["Darkshore Rares"] = "Rares de Sombrivage"
SN["Delve Treasure Chests"] = "Coffres au trésor des gouffres"
SN["Delves"] = "Gouffres"
SN["Diablo 2 expansion bonus"] = "Bonus d'extension Diablo 2"
SN["Diablo 4 pre-order"] = "Précommande de Diablo 4"
SN["Fanta x Warcraft collab"] = "Collaboration Fanta et Warcraft"
SN["Highmountain Tauren Paragon Chest"] = "Coffre de parangon des Taurens de Haut-Roc"
SN["In-game shop"] = "Boutique en jeu"
SN["Large Starter Decor Pack"] = "Grand pack de décorations de départ"
SN["Login Reward (Midnight)"] = "Récompense de connexion (Midnight)"
SN["Lush Garden Decor Pack"] = "Pack de décorations de jardin luxuriant"
SN["Lush Garden Decor Pack 2"] = "Pack de décorations de jardin luxuriant 2"
SN["Midnight Delves"] = "Gouffres de Midnight"
SN["Pepe (neighborhood billboard)"] = "Pepe (panneau d'affichage du quartier)"
SN["Pinterest London IRL quest (March 21)"] = "Chasse au trésor Pinterest à Londres (21 mars)"
SN["Ral'kala"] = "Ral'kala"
SN["Roofus charity pet (The Roofus Pack)"] = "Mascotte caritative Architoutou (le pack Architoutou)"
SN["Rotmire"] = "Embourbe-pourri"
...
SN["Shop"] = "Boutique"
SN["Small Starter Decor Pack"] = "Petit pack de décorations de départ"
SN["Spring Blossom Decor Pack"] = "Pack de décorations à floraison printanière"
SN["Spring Blossom Decor Pack 2"] = "Pack de décorations à floraison printanière 2"
...
SN["Twitch drop (Feb 26 to Mar 24)"] = "Twitch Drop (26 fév. au 24 mars)"
SN["Twitch drop (June 16 to July 14)"] = "Twitch Drop (16 juin au 14 juillet)"
SN["Undermine Jobs"] = "Travaux de Terremine"
SN["Victorious Stormarion Cache"] = "Cache victorieuse de Stormarion"
...
SN["Avatar of Sethraliss (Temple of Sethraliss)"] = "Avatar de Sephraliss (Temple de Sephraliss)"
...
SN["Dazar, The First King (Kings' Rest)"] = "Dazar, le premier roi (Repos des rois)"
...
SN["Entombed Sentinels (The Venomous Abyss)"] = "Sentinelles inhumées (L’abîme Venimeux)"
...
SN["Midnight Falls (March on Quel'Danas)"] = "Glas de minuit (Marche sur Quel'Danas)"
SN["Nalorakk"] = "Nalorakk"
SN["Nek'zali the Soulcoiler (The Venomous Abyss)"] = "Nek'zali l'Entortillâme (L’abîme Venimeux)"
SN["Nymrissa Wavecaller (The Tidebound Grotto)"] = "Nymrissa Mande-vagues (La grotte des Marées)"
...
SN["Shade of Xavius (Darkheart Thicket)"] = "Ombre de Xavius (Fourré Sombrecœur)"
SN["Skulloc (Iron Docks)"] = "Skulloc (Docks de Fer)"
SN["Spellblade Aluriel (The Nighthold)"] = "Lame-de-sort Aluriel (Le Palais Sacrenuit)"
SN["Sszorak (The Venomous Abyss)"] = "Sszorak (L’abîme Venimeux)"
SN["Teron'gor"] = "Teron'gor"
SN["The Coiled Altar (The Venomous Abyss)"] = "L’Autel annelé (L’abîme Venimeux)"
SN["The Darkness"] = "Les Ténèbres"
SN["The Lost Explorers (The Venomous Abyss)"] = "L’expédition perdue (L’abîme Venimeux)"
SN["The Restless Cabal"] = "La Cabale agitée"
SN["The Restless Heart"] = "Le Cœur agité"
SN["The Twin Fangs (The Venomous Abyss)"] = "Les crochets jumeaux (L’abîme Venimeux)"
SN["Ula'tek (Heroic, The Venomous Abyss)"] = "Ula'tek (Héroïque, L’abîme Venimeux)"
SN["Ula'tek (Mythic, The Venomous Abyss)"] = "Ula'tek (Mythique, L’abîme Venimeux)"
SN["Ula'tek (Raid Finder/Normal, The Venomous Abyss)"] = "Ula'tek (Outil Raids/Normal, L’abîme Venimeux)"
SN["Ula'tek (The Venomous Abyss)"] = "Ula'tek (L’abîme Venimeux)"
SN["Vaelgor & Ezzorak"] = "Vaelgor et Ezzorak"
SN["Vanessa VanCleef"] = "Vanessa VanCleef"
SN["Vashnik the Malignant (The Venomous Abyss)"] = "Vashnik le Malveillant (L’abîme Venimeux)"
...
-- Treasures
SN["Crumbling Urn (The Coiled Isle)"] = "Urne croulante (Île Annelée)"
SN["Forgotten Treasure (The Coiled Isle)"] = "Trésor oublié (Île Annelée)"
SN["Glimmering Treasure Chest"] = "Coffre au trésor scintillant"
...
SN["Stinking Vessel (The Coiled Isle)"] = "Récipient nauséabond (Île Annelée)"
SN["Stone Vat (Eversong Woods)"] = "Cuve en pierre (Bois des Chants éternels)"
SN["Undermine"] = "Terremine"
SN["Venomjade Necklace (The Coiled Isle)"] = "Collier de jade-venin (Île Annelée)"
SN["Zul'jan's Strongbox (Altar of Fangs)"] = "Coffre renforcé de Zul’jan (Autel des crochets)"

-- Recipe sources (Professions tab)
SN["Construct V'anore"] = "Assemblage V'anore"
SN["Jan'sari the Watchful"] = "Jan'sari la Vigilante"
SN["Navigator Otoola"] = "Navigatrice Otoola"
SN["Second Mate Sluggs"] = "Quartier-maître Sluggs"
SN["Thalassian Recipe in a Bottle"] = "Recette thalassienne en bouteille"
