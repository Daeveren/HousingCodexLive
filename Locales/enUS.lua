...
L["OPTIONS_SHOW_WELCOME_TOOLTIP_DISABLED"] = "Use /hc welcome to show the welcome screen"
...
L["WELCOME_SET_KEYBIND"] = "or by pressing your preferred"
L["WELCOME_KEYBIND_LABEL"] = "keybind:"
...
L["WELCOME_F1_DESC"] = "Inspect every decor item in a fully interactive 3D viewer. Rotate, zoom, and examine details up close in three resizable preview modes."
L["WELCOME_F2_TITLE"] = "Decor Catalog & Grid"
L["WELCOME_F2_DESC"] = "Browse the full housing catalog with a customizable preview grid. Filter by expansion, category, and collection status with instant search."
L["WELCOME_F3_TITLE"] = "Sources & Discovery"
L["WELCOME_F3_DESC"] = "Find exactly how to get uncollected decor. See sources broken down by quests, achievements, vendors, drops, and professions."
L["WELCOME_F4_TITLE"] = "Vendor Indicators"
L["WELCOME_F4_DESC"] = "Never miss housing decor at a vendor. Decor icons appear directly on vendor windows so you can spot collectible items at a glance."
L["WELCOME_F5_TITLE"] = "Map Integration"
L["WELCOME_F5_DESC"] = "Decor vendors are pinned on the world map and zone maps. A zone overlay shows how much uncollected decor is available in each zone."
L["WELCOME_F6_TITLE"] = "Collection Progress"
L["WELCOME_F6_DESC"] = "Track your completion with detailed progress bars across multiple categories. See at a glance what you've collected and what's still out there."
