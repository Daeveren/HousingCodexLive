...
L["FILTER_PROMO_ONLY"] = "Promo only"
L["FILTER_HIDE_SHOP_ITEMS"] = "Hide Shop Items"
L["FILTER_CURRENCY_HEADER"] = "Currency"
L["FILTER_ALL_CURRENCIES"] = "All currencies"
L["FILTER_NO_CURRENCIES"] = "No currencies found"
L["FILTER_ADDED_PATCH_HEADER"] = "Added in patch"
L["FILTER_NO_PATCHES"] = "No patch versions found"
L["FILTERS"] = "Filters"
...
L["DETAILS_ADDED_PATCH"] = "Added in patch:"
L["DETAILS_DYEABLE"] = "Dyeable"
L["DETAILS_NOT_DYEABLE"] = "Not Dyeable"
L["DETAILS_SOURCE_UNKNOWN"] = "Unknown source"
L["DETAILS_SOURCE_CATEGORY"] = "Category"
L["DETAILS_SOURCE_VENDOR"] = "Vendor"
L["DETAILS_SOURCE_ZONE"] = "Zone"
L["DETAILS_SOURCE_COST"] = "Cost"
L["SOURCE_PROMOTIONAL"] = "Promotional"
L["TOOLTIP_PROMO_DECOR"] = "Promotional decor item"
...
L["OPTIONS_RESET_WINDOW"] = "Reset window"
L["OPTIONS_RESET_WINDOW_TOOLTIP"] = "Reset the window position and size"
L["OPTIONS_SHOW_WELCOME"] = "Welcome Screen"
L["OPTIONS_SHOW_WELCOME_TOOLTIP"] = "Show the welcome screen"
L["OPTIONS_SEE_HIDDEN_ITEMS"] = "See Hidden Items"
L["OPTIONS_SEE_HIDDEN_ITEMS_TOOLTIP"] = "View and restore items hidden from Housing Codex lists"
L["OPTIONS_COMMAND_HELP"] = "/hc help"
L["OPTIONS_COMMAND_HELP_TOOLTIP_TITLE"] = "Slash Command Help"
L["OPTIONS_COMMAND_HELP_TOOLTIP_DESC"] = "Prints Housing Codex slash-command help in chat. Use this when you need the window or troubleshooting commands without leaving Settings."
L["SIZE_RESET"] = "Window size reset to default."

L["OPTIONS_SECTION_KEYBIND"] = "Keybind"
L["OPTIONS_SECTION_TROUBLESHOOTING"] = "Troubleshooting & Debugging"
L["OPTIONS_DISABLE_CUSTOM_FONT"] = "Disable custom font"
L["OPTIONS_ENABLE_CUSTOM_FONT"] = "Enable custom font"
...
L["HELP_ALIASES"] = "Aliases: /hcodex, /housingcodex"
L["HELP_TOGGLE"] = "/hc - Toggle main window"
L["HELP_SETTINGS"] = "/hc settings/options - Open settings"
L["HELP_RESET"] = "/hc reset - Reset window position"
L["HELP_RETRY"] = "/hc retry/reload - Retry loading data"
L["HELP_HELP"] = "/hc help/? - Show this help"
L["HELP_DEBUG"] = "/hc debug - Toggle debug mode"
L["HELP_STATS"] = "/hc stats - Show debug counters"
L["HELP_STATS_RESET"] = "/hc stats reset - Reset debug counters"
L["HELP_LOG"] = "|cFFFFD100/hc log|r - Show event trace log (requires debug mode)"
L["HELP_LOG_CLEAR"] = "|cFFFFD100/hc log clear|r - Clear event trace log"
L["HELP_FONT"] = "/hc font - Toggle the Housing Codex custom font"
L["HELP_WELCOME"] = "/hc welcome - Show the welcome screen"
L["HELP_WHATSNEW"] = "/hc whatsnew - Show the latest changes"
L["HELP_INSPECT"] = "/hc inspect <name> - Inspect a decor record for debugging"
...
L["LDB_POPUP_TOTAL_OWNED"] = "Total Owned (incl. dupes)"
L["LDB_POPUP_TOTAL_ITEMS"] = "Total Items"
L["LDB_POPUP_PERCENT"] = "Collection %"
L["LDB_TOOLTIP_WISHLIST"] = "Wishlist"
L["LDB_TOOLTIP_WISHLIST_COUNT"] = "%d items"
L["LDB_TOOLTIP_SHIFT_RIGHT"] = "|cffffffffShift-Right|r to view collection progress"
...
L["CONTEXT_MENU_HIDE_ITEM"] = "Hide this item"
L["CONTEXT_MENU_UNHIDE_ITEM"] = "Unhide this item"
L["HIDDEN_ITEMS_TITLE"] = "Hidden Items"
L["HIDDEN_ITEMS_EMPTY"] = "No hidden items"
L["HIDDEN_ITEMS_EMPTY_DESC"] = "Right-click an item in Housing Codex and choose Hide this item to add it here."
L["HIDDEN_ITEMS_UNHIDE"] = "Unhide"
L["HIDDEN_ITEMS_CLEAR_ALL"] = "Clear All"
L["HIDDEN_ITEMS_CLEAR_ALL_TOOLTIP"] = "Restore every item hidden with Hide this item"
L["HIDDEN_ITEMS_CLEAR_ALL_CONFIRM"] = "Unhide all %d hidden items?"
L["HIDDEN_ITEMS_HIDE_CONFIRM"] = "Hide \"%s\"?"
L["HIDDEN_ITEMS_COUNT"] = "%d hidden"
...
-- Vendors Tab
--------------------------------------------------------------------------------
L["VENDORS_SEARCH_PLACEHOLDER"] = "Search vendors, zones, currencies, or items..."
L["VENDORS_FILTER_ALL"] = "All"
L["VENDORS_FILTER_INCOMPLETE"] = "Incomplete"
L["VENDORS_FILTER_COMPLETE"] = "Complete"
L["VENDORS_FILTER_CURRENCY"] = "Currency"
L["VENDORS_FILTER_ALL_CURRENCIES"] = "All currencies"
L["VENDORS_FILTER_NO_CURRENCIES"] = "No currencies found"
...
L["VENDORS_EMPTY_NO_RESULTS"] = "No vendors match your filters"
...
L["WISHLIST_SEARCH_PLACEHOLDER"] = "Search wishlist..."
L["WISHLIST_NO_SEARCH_RESULTS"] = "No wishlist items match your search"
L["WISHLIST_NO_SEARCH_RESULTS_DESC"] = "Try a different item name or clear the search box."
L["WISHLIST_GROUP_BY_SOURCE"] = "Group by source"
L["WISHLIST_GROUP_OTHER"] = "Other"
L["WISHLIST_GROUP_HEADER_COUNT"] = "%d total, %d collected"
L["PROGRESS_STAT_WISHLIST"] = "Wishlist"
L["PROGRESS_STAT_HIDDEN"] = "Hidden"
L["PROGRESS_BUDGET_HEADER"] = "PLOT DECOR BUDGET"
L["PROGRESS_BUDGET_INTERIOR"] = "Interior"
L["PROGRESS_BUDGET_PLOT"] = "Plot"
L["PROGRESS_BUDGET_LAST_UPDATED"] = "Last updated: %s"
L["PROGRESS_BUDGET_OUTDOOR"] = "Outdoor"
L["PROGRESS_BUDGET_EMPTY_HINT"] = "Visit this house plot and enter Edit House mode outdoors and indoors to capture both budget values."
L["PROGRESS_BUDGET_REFRESH_BOTH_HINT"] = "Both budget values need to be verified again. Enter Edit House mode outdoors and indoors at this house."
L["PROGRESS_BUDGET_REFRESH_OUTDOOR_HINT"] = "The outdoor budget needs to be verified again. Enter Edit House mode outdoors on this plot."
L["PROGRESS_BUDGET_REFRESH_INTERIOR_HINT"] = "The indoor budget needs to be verified again. Enter Edit House mode inside this house."
L["PROGRESS_BUDGET_INDOOR"] = "Indoor"
L["PROGRESS_BUDGET_LEVEL"] = "Level %d"
L["PROGRESS_BUDGET_LEVEL_UNKNOWN"] = "Level --"
L["PROGRESS_BUDGET_TIME_AGO"] = "%s ago"
L["PROGRESS_TIME_MINUTE"] = "%d minute"
L["PROGRESS_TIME_MINUTES"] = "%d minutes"
L["PROGRESS_TIME_HOUR"] = "%d hour"
L["PROGRESS_TIME_HOURS"] = "%d hours"
L["PROGRESS_TIME_DAY"] = "%d day"
L["PROGRESS_TIME_DAYS"] = "%d days"
L["PROGRESS_HISTORY_HEADER"] = "DECOR IN LAST %d DAYS"
L["PROGRESS_HISTORY_SUMMARY"] = "+%d in the last %d days"
L["PROGRESS_HISTORY_TOOLTIP_TODAY"] = "Today"
L["PROGRESS_HISTORY_TOOLTIP_DAY_AGO"] = "%d day ago"
L["PROGRESS_HISTORY_TOOLTIP_DAYS_AGO"] = "%d days ago"
L["PROGRESS_HISTORY_TOOLTIP_GAIN"] = "+%d decor learned"
L["PROGRESS_HISTORY_TOOLTIP_EMPTY"] = "No new decor recorded"
L["PROGRESS_HISTORY_TOOLTIP_START"] = "Started day: %s"
L["PROGRESS_HISTORY_TOOLTIP_TOTAL"] = "Recorded total: %s"
L["PROGRESS_HISTORY_TOOLTIP_NO_SNAPSHOT"] = "No snapshot saved for this day"
L["PROGRESS_HISTORY_TOOLTIP_HINT"] = "Updates when your collected decor count changes."
L["PROGRESS_ACHIEVEMENT_CATEGORIES"] = "Achievement Categories"
L["PROGRESS_DROP_CATEGORIES"] = "Drop Categories"
--------------------------------------------------------------------------------
...
L["ENDEAVORS_XP_TOOLTIP_AVAILABLE"] = "Available: %s"
...
L["RENOWN_STANDING_GOOD_FRIEND"] = "Good Friend"
L["RENOWN_FACTION_UNKNOWN_FORMAT"] = "Faction #%d"
...
SN["Arcanostorage Sphere"] = "Arcanostorage Sphere"
SN["BlizzCon 2026 Twitch / YouTube reward (4 hours; claim to unlock extra copies)"] = "BlizzCon 2026 Twitch / YouTube reward (4 hours; claim to unlock extra copies)"
SN["BlizzCon 2026 in-game goodies"] = "BlizzCon 2026 in-game goodies"
SN["Brewfest (seasonal event)"] = "Brewfest (seasonal event)"
SN["Darkshore Rares"] = "Darkshore Rares"
SN["Delve Treasure Chests"] = "Delve Treasure Chests"
SN["Delves"] = "Delves"
SN["Diablo 2 expansion bonus"] = "Diablo 2 expansion bonus"
SN["Diablo 4 pre-order"] = "Diablo 4 pre-order"
SN["Fanta x Warcraft collab"] = "Fanta x Warcraft collab"
SN["Highmountain Tauren Paragon Chest"] = "Highmountain Tauren Paragon Chest"
SN["In-game shop"] = "In-game shop"
SN["Large Starter Decor Pack"] = "Large Starter Decor Pack"
SN["Login Reward (Midnight)"] = "Login Reward (Midnight)"
SN["Lush Garden Decor Pack"] = "Lush Garden Decor Pack"
SN["Lush Garden Decor Pack 2"] = "Lush Garden Decor Pack 2"
SN["Midnight Delves"] = "Midnight Delves"
SN["Pepe (neighborhood billboard)"] = "Pepe (neighborhood billboard)"
SN["Pinterest London IRL quest (March 21)"] = "Pinterest London IRL quest (March 21)"
SN["Ral'kala"] = "Ral'kala"
SN["Roofus charity pet (The Roofus Pack)"] = "Roofus charity pet (The Roofus Pack)"
SN["Rotmire"] = "Rotmire"
...
SN["Shop"] = "Shop"
SN["Small Starter Decor Pack"] = "Small Starter Decor Pack"
SN["Spring Blossom Decor Pack"] = "Spring Blossom Decor Pack"
SN["Spring Blossom Decor Pack 2"] = "Spring Blossom Decor Pack 2"
...
SN["Twitch drop (June 16 to July 14)"] = "Twitch drop (June 16 to July 14)"
SN["Undermine Jobs"] = "Undermine Jobs"
SN["Victorious Stormarion Cache"] = "Victorious Stormarion Cache"
...
SN["Avatar of Sethraliss (Temple of Sethraliss)"] = "Avatar of Sethraliss (Temple of Sethraliss)"
...
SN["Dazar, The First King (Kings' Rest)"] = "Dazar, The First King (Kings' Rest)"
...
SN["Entombed Sentinels (The Venomous Abyss)"] = "Entombed Sentinels (The Venomous Abyss)"
...
SN["Nek'zali the Soulcoiler (The Venomous Abyss)"] = "Nek'zali the Soulcoiler (The Venomous Abyss)"
SN["Nymrissa Wavecaller (The Tidebound Grotto)"] = "Nymrissa Wavecaller (The Tidebound Grotto)"
...
SN["Sszorak (The Venomous Abyss)"] = "Sszorak (The Venomous Abyss)"
SN["Teron'gor"] = "Teron'gor"
SN["The Coiled Altar (The Venomous Abyss)"] = "The Coiled Altar (The Venomous Abyss)"
SN["The Darkness"] = "The Darkness"
SN["The Lost Explorers (The Venomous Abyss)"] = "The Lost Explorers (The Venomous Abyss)"
SN["The Restless Cabal"] = "The Restless Cabal"
SN["The Restless Heart"] = "The Restless Heart"
SN["The Twin Fangs (The Venomous Abyss)"] = "The Twin Fangs (The Venomous Abyss)"
SN["Ula'tek (Heroic, The Venomous Abyss)"] = "Ula'tek (Heroic, The Venomous Abyss)"
SN["Ula'tek (Mythic, The Venomous Abyss)"] = "Ula'tek (Mythic, The Venomous Abyss)"
SN["Ula'tek (Raid Finder/Normal, The Venomous Abyss)"] = "Ula'tek (Raid Finder/Normal, The Venomous Abyss)"
SN["Ula'tek (The Venomous Abyss)"] = "Ula'tek (The Venomous Abyss)"
SN["Vaelgor & Ezzorak"] = "Vaelgor & Ezzorak"
SN["Vanessa VanCleef"] = "Vanessa VanCleef"
SN["Vashnik the Malignant (The Venomous Abyss)"] = "Vashnik the Malignant (The Venomous Abyss)"
...
-- Treasures
SN["Crumbling Urn (The Coiled Isle)"] = "Crumbling Urn (The Coiled Isle)"
SN["Forgotten Treasure (The Coiled Isle)"] = "Forgotten Treasure (The Coiled Isle)"
SN["Glimmering Treasure Chest"] = "Glimmering Treasure Chest"
...
SN["Stinking Vessel (The Coiled Isle)"] = "Stinking Vessel (The Coiled Isle)"
SN["Stone Vat (Eversong Woods)"] = "Stone Vat (Eversong Woods)"
SN["Undermine"] = "Undermine"
SN["Venomjade Necklace (The Coiled Isle)"] = "Venomjade Necklace (The Coiled Isle)"
SN["Zul'jan's Strongbox (Altar of Fangs)"] = "Zul'jan's Strongbox (Altar of Fangs)"

-- Recipe sources (Professions tab)
SN["Construct V'anore"] = "Construct V'anore"
SN["Jan'sari the Watchful"] = "Jan'sari the Watchful"
SN["Navigator Otoola"] = "Navigator Otoola"
SN["Second Mate Sluggs"] = "Second Mate Sluggs"
SN["Thalassian Recipe in a Bottle"] = "Thalassian Recipe in a Bottle"
