...
L["FILTER_PROMO_ONLY"] = "Только промо"
L["FILTER_HIDE_SHOP_ITEMS"] = "Скрыть предметы из магазина"
L["FILTER_CURRENCY_HEADER"] = "Валюта"
L["FILTER_ALL_CURRENCIES"] = "Все валюты"
L["FILTER_NO_CURRENCIES"] = "Валюты не найдены"
L["FILTER_ADDED_PATCH_HEADER"] = "Добавлено в обновлении"
L["FILTER_NO_PATCHES"] = "Версии обновлений не найдены"
L["FILTERS"] = "Фильтры"
...
L["DETAILS_PLACE"] = "Тип:"
L["DETAILS_ADDED_PATCH"] = "Добавлено в обновлении:"
L["DETAILS_DYEABLE"] = "Можно перекрасить"
L["DETAILS_NOT_DYEABLE"] = "Нельзя перекрасить"
L["DETAILS_SOURCE_UNKNOWN"] = "Источник неизвестен"
L["DETAILS_SOURCE_CATEGORY"] = "Категория"
L["DETAILS_SOURCE_VENDOR"] = "Торговец"
L["DETAILS_SOURCE_ZONE"] = "Зона"
L["DETAILS_SOURCE_COST"] = "Стоимость"
L["SOURCE_PROMOTIONAL"] = "Промо"
L["TOOLTIP_PROMO_DECOR"] = "Промо-предмет декора"
L["TILE_BADGE_PROMO"] = "ПРОМО"
...
L["PREVIEW_NOT_IN_CATALOG"] = "Еще не добавлено в каталог жилья"
...
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER"] = "Фильтровать торговцев профессий в Луносвете"
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER_TOOLTIP"] = "Показывать только торговцев профессий в Луносвете для профессий, изученных этим персонажем"
...
L["OPTIONS_RESET_WINDOW"] = "Сбросить окно"
L["OPTIONS_RESET_WINDOW_TOOLTIP"] = "Сбросить положение и размер окна"
L["OPTIONS_SHOW_WELCOME"] = "Экран приветствия"
L["OPTIONS_SHOW_WELCOME_TOOLTIP"] = "Показывать приветственное окно"
L["OPTIONS_SEE_HIDDEN_ITEMS"] = "Показать скрытые предметы"
L["OPTIONS_SEE_HIDDEN_ITEMS_TOOLTIP"] = "Просмотреть и восстановить предметы, скрытые из списков Housing Codex"
L["OPTIONS_COMMAND_HELP"] = "/hc help"
L["OPTIONS_COMMAND_HELP_TOOLTIP_TITLE"] = "Справка по командам"
L["OPTIONS_COMMAND_HELP_TOOLTIP_DESC"] = "Выводит справку по slash-командам Housing Codex в чат. Используйте для команд окна и устранения неполадок прямо из настроек."
L["SIZE_RESET"] = "Размер окна сброшен до стандартного."

L["OPTIONS_SECTION_KEYBIND"] = "Горячая клавиша"
L["OPTIONS_SECTION_TROUBLESHOOTING"] = "Устранение неполадок и отладка"
L["OPTIONS_DISABLE_CUSTOM_FONT"] = "Отключить пользовательский шрифт"
L["OPTIONS_ENABLE_CUSTOM_FONT"] = "Включить пользовательский шрифт"
L["OPTIONS_DISABLE_CUSTOM_FONT_TOOLTIP"] = "Используйте этот параметр, если пользовательский шрифт вызывает отсутствующие символы или проблемы с читаемостью. Housing Codex разрабатывается и тестируется со встроенным пользовательским шрифтом; замены шрифта не поддерживаются."
L["OPTIONS_CUSTOM_FONT_CONFIRM"] = "%s?\n\n%s"
...
L["HELP_ALIASES"] = "Псевдонимы: /hcodex, /housingcodex"
L["HELP_TOGGLE"] = "/hc — открыть/закрыть главное окно"
L["HELP_SETTINGS"] = "/hc settings/options — открыть настройки"
L["HELP_RESET"] = "/hc reset — сбросить положение окна"
L["HELP_RETRY"] = "/hc retry/reload — повторить попытку загрузки данных"
...
L["HELP_STATS_RESET"] = "/hc stats reset — сбросить счетчики отладки"
L["HELP_LOG"] = "|cFFFFD100/hc log|r — показать журнал событий (требуется режим отладки)"
L["HELP_LOG_CLEAR"] = "|cFFFFD100/hc log clear|r — очистить журнал событий"
L["HELP_FONT"] = "/hc font — переключить пользовательский шрифт Housing Codex"
L["HELP_WELCOME"] = "/hc welcome — показать экран приветствия"
L["HELP_WHATSNEW"] = "/hc whatsnew — показать последние изменения"
L["HELP_INSPECT"] = "/hc inspect <имя> — проверить запись декора для отладки"
...
L["EVENT_TRACE_LOG_CLEARED"] = "Журнал событий очищен"
...
L["CONTEXT_MENU_HIDE_ITEM"] = "Скрыть этот предмет"
L["CONTEXT_MENU_UNHIDE_ITEM"] = "Показать этот предмет"
L["HIDDEN_ITEMS_TITLE"] = "Скрытые предметы"
L["HIDDEN_ITEMS_EMPTY"] = "Нет скрытых предметов"
L["HIDDEN_ITEMS_EMPTY_DESC"] = "Щелкните предмет в Housing Codex правой кнопкой мыши и выберите Скрыть этот предмет, чтобы добавить его сюда."
L["HIDDEN_ITEMS_UNHIDE"] = "Показать"
L["HIDDEN_ITEMS_CLEAR_ALL"] = "Показать все"
L["HIDDEN_ITEMS_CLEAR_ALL_TOOLTIP"] = "Восстановить все предметы, скрытые через Скрыть этот предмет"
L["HIDDEN_ITEMS_CLEAR_ALL_CONFIRM"] = "Показать все скрытые предметы (%d)?"
L["HIDDEN_ITEMS_HIDE_CONFIRM"] = "Скрыть «%s»?"
L["HIDDEN_ITEMS_COUNT"] = "%d скрыто"
...
-- Vendors Tab
--------------------------------------------------------------------------------
L["VENDORS_SEARCH_PLACEHOLDER"] = "Поиск торговцев, зон, валют или предметов..."
L["VENDORS_FILTER_ALL"] = "Все"
L["VENDORS_FILTER_INCOMPLETE"] = "Не все куплено"
L["VENDORS_FILTER_COMPLETE"] = "Все куплено"
L["VENDORS_FILTER_CURRENCY"] = "Валюта"
L["VENDORS_FILTER_ALL_CURRENCIES"] = "Все валюты"
L["VENDORS_FILTER_NO_CURRENCIES"] = "Валюты не найдены"
...
L["VENDOR_PIN_PROMO"] = "Промо: %d/%d"
L["VENDOR_PIN_UNCOLLECTED_HEADER"] = "Не собранный декор:"
L["VENDOR_PIN_ITEM_PROMO"] = "промо"
...
L["VENDOR_PIN_VENDOR_COUNT"] = "Торговцев: %d"
L["VENDOR_PIN_VENDOR_LIST_HEADER"] = "Список торговцев:"
L["VENDOR_PIN_VENDOR_ENTRY"] = "%s (%d/%d)"
L["VENDOR_PIN_VENDOR_ENTRY_PROMO_ONLY"] = "%s (промо: %d/%d)"
...
L["CURRENCY_GOLD_FORMAT"] = "%s |4золотая монета:золотые монеты:золотых монет;"
...
L["VENDOR_CLASS_HALL_SUFFIX"] = "оплот класса: %s"
L["VENDOR_HOUSING_ZONE_SUFFIX"] = "жилая зона: %s"
...
--------------------------------------------------------------------------------
L["TREASURE_HUNT_WAYPOINT_TITLE"] = "Сокровище декора"
...
L["PROGRESS_PVP_CATEGORIES"] = "PvP-категории"
L["PROGRESS_PROFESSIONS"] = "Профессии"
L["PROGRESS_ALMOST_THERE"] = "Наибольший прогресс"
L["PROGRESS_OVERVIEW"] = "ОБЗОР ПРОГРЕССА"
L["PROGRESS_ALL_DECOR_COLLECTED"] = "Собрано видимых предметов декора"
...
L["PROGRESS_SOURCE_PROMOTIONAL"] = "Промо"
L["PROGRESS_LOADING"] = "Загрузка данных о прогрессе..."

L["WISHLIST_SEARCH_PLACEHOLDER"] = "Поиск в списке желаемого..."
L["WISHLIST_NO_SEARCH_RESULTS"] = "В списке желаемого ничего не найдено"
L["WISHLIST_NO_SEARCH_RESULTS_DESC"] = "Попробуйте другое название или очистите поиск."
L["WISHLIST_GROUP_BY_SOURCE"] = "Группировать по источнику"
L["WISHLIST_GROUP_OTHER"] = "Другое"
L["WISHLIST_GROUP_HEADER_COUNT"] = "Всего: %d, собрано: %d"
L["PROGRESS_STAT_WISHLIST"] = "Список желаемого"
L["PROGRESS_STAT_HIDDEN"] = "Скрыто"
L["PROGRESS_BUDGET_HEADER"] = "БЮДЖЕТ ДЕКОРА УЧАСТКА"
L["PROGRESS_BUDGET_INTERIOR"] = "Интерьер"
L["PROGRESS_BUDGET_PLOT"] = "Участок"
L["PROGRESS_BUDGET_LAST_UPDATED"] = "Последнее обновление: %s"
L["PROGRESS_BUDGET_OUTDOOR"] = "Снаружи"
L["PROGRESS_BUDGET_EMPTY_HINT"] = "Посетите этот участок и войдите в режим редактирования дома снаружи и внутри, чтобы сохранить оба значения бюджета."
L["PROGRESS_BUDGET_REFRESH_BOTH_HINT"] = "Оба значения бюджета нужно проверить заново. Включите режим редактирования дома снаружи и внутри этого дома."
L["PROGRESS_BUDGET_REFRESH_OUTDOOR_HINT"] = "Наружный бюджет нужно проверить заново. Включите режим редактирования дома снаружи на этом участке."
L["PROGRESS_BUDGET_REFRESH_INTERIOR_HINT"] = "Внутренний бюджет нужно проверить заново. Включите режим редактирования дома внутри этого дома."
L["PROGRESS_BUDGET_INDOOR"] = "Внутри"
L["PROGRESS_BUDGET_LEVEL"] = "Уровень %d"
L["PROGRESS_BUDGET_LEVEL_UNKNOWN"] = "Уровень --"
L["PROGRESS_BUDGET_TIME_AGO"] = "%s назад"
L["PROGRESS_TIME_MINUTE"] = "%d мин."
L["PROGRESS_TIME_MINUTES"] = "%d мин."
L["PROGRESS_TIME_HOUR"] = "%d ч."
L["PROGRESS_TIME_HOURS"] = "%d ч."
L["PROGRESS_TIME_DAY"] = "%d д."
L["PROGRESS_TIME_DAYS"] = "%d д."
L["PROGRESS_HISTORY_HEADER"] = "ДЕКОР ЗА ПОСЛЕДНИЕ %d ДН."
L["PROGRESS_HISTORY_SUMMARY"] = "+%d за последние %d дн."
L["PROGRESS_HISTORY_TOOLTIP_TODAY"] = "Сегодня"
L["PROGRESS_HISTORY_TOOLTIP_DAY_AGO"] = "%d день назад"
L["PROGRESS_HISTORY_TOOLTIP_DAYS_AGO"] = "%d дн. назад"
L["PROGRESS_HISTORY_TOOLTIP_GAIN"] = "+%d предметов декора изучено"
L["PROGRESS_HISTORY_TOOLTIP_EMPTY"] = "Новый декор не записан"
L["PROGRESS_HISTORY_TOOLTIP_START"] = "Начало дня: %s"
L["PROGRESS_HISTORY_TOOLTIP_TOTAL"] = "Записанный итог: %s"
L["PROGRESS_HISTORY_TOOLTIP_NO_SNAPSHOT"] = "За этот день нет сохраненного снимка"
L["PROGRESS_HISTORY_TOOLTIP_HINT"] = "Обновляется, когда меняется число собранного декора."
L["PROGRESS_ACHIEVEMENT_CATEGORIES"] = "Категории достижений"
L["PROGRESS_DROP_CATEGORIES"] = "Категории добычи"
--------------------------------------------------------------------------------
...
L["WELCOME_OPEN_INSTRUCTION"] = "Аддон можно открыть командой %s или назначить клавишу в меню %s."
...
L["WHATSNEW_V150_F1_DESC"] = "Мгновенный обзор вашей коллекции: общая статистика, данные по типам источников и категории с наибольшим прогрессом."
...
-- Endeavors Panel
--------------------------------------------------------------------------------
L["ENDEAVORS_TITLE"] = "Начинания"
L["ENDEAVORS_BAR_ABBREV"] = "Н"
L["ENDEAVORS_OPTIONS"] = "Настройки начинаний"
L["ENDEAVORS_OPTIONS_TOOLTIP"] = "Настроить панель начинаний"
...
L["ENDEAVORS_OPT_SECTION_ENDEAVOR"] = "Прогресс начинания"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR"] = "Показывать полосу начинания"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TIP"] = "Отображать полосу прогресса начинания района"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT"] = "Текст на полосе начинания"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT_TIP"] = "Отображать числовые значения на полосе прогресса начинания"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT"] = "Проценты на полосе начинания"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT_TIP"] = "Отображать проценты на полосе прогресса начинания"
...
L["ENDEAVORS_XP_TOOLTIP_AVAILABLE"] = "Доступно: %s"
L["ENDEAVORS_XP_TOOLTIP_CLICK"] = "Клик: открыть панель дома"
L["ENDEAVORS_TOOLTIP_CLICK"] = "Клик: открыть меню начинаний"
L["ENDEAVORS_PCT_DONE"] = "ГОТОВО"
L["OPTIONS_SECTION_ENDEAVORS"] = "Начинания"
L["OPTIONS_ENDEAVORS_ENABLED"] = "Включить панель начинаний"
L["OPTIONS_ENDEAVORS_ENABLED_TOOLTIP"] = "Показывать мини-панель начинаний, когда вы находитесь в жилом районе с домом"
L["ENDEAVORS_OPT_ENABLED"] = "Включить панель начинаний"
L["ENDEAVORS_OPT_ENABLED_TIP"] = "Показывать панель начинаний, когда вы находитесь в жилом районе с домом"
...
L["ENDEAVORS_OPT_SCALE_TIP"] = "Изменить масштаб панели начинаний"
...
SN["Arcanostorage Sphere"] = "Сфера магического хранения"
SN["BlizzCon 2026 Twitch / YouTube reward (4 hours; claim to unlock extra copies)"] = "Награда за просмотр BlizzCon 2026 на Twitch / YouTube (4 часа; получите, чтобы открыть дополнительные копии)"
SN["BlizzCon 2026 in-game goodies"] = "Внутриигровые подарки BlizzCon 2026"
SN["Brewfest (seasonal event)"] = "Хмельной фестиваль (сезонное событие)"
SN["Darkshore Rares"] = "Редкие противники: Темные берега"
SN["Delve Treasure Chests"] = "Сундуки с сокровищами из вылазок"
SN["Delves"] = "Вылазки"
SN["Diablo 2 expansion bonus"] = "Бонус за дополнение Diablo II"
SN["Diablo 4 pre-order"] = "Предзаказ Diablo IV"
SN["Fanta x Warcraft collab"] = "Коллаборация Fanta и Warcraft"
SN["Highmountain Tauren Paragon Chest"] = "Сундук идеала тауренов Крутогорья"
SN["In-game shop"] = "Внутриигровой магазин"
SN["Large Starter Decor Pack"] = "Крупный стартовый набор декора"
SN["Login Reward (Midnight)"] = "Награда за вход (Midnight)"
SN["Lush Garden Decor Pack"] = "Набор декора «Роскошный сад»"
SN["Lush Garden Decor Pack 2"] = "Набор декора «Роскошный сад» 2"
SN["Midnight Delves"] = "Вылазки: Midnight"
SN["Pepe (neighborhood billboard)"] = "Pepe (доска объявлений района)"
SN["Pinterest London IRL quest (March 21)"] = "Задание Pinterest в реальном мире в Лондоне (21 марта)"
SN["Ral'kala"] = "Рал'кала"
SN["Roofus charity pet (The Roofus Pack)"] = "Благотворительный питомец Roofus (набор Roofus)"
SN["Rotmire"] = "Гнилотоп"
...
SN["Shop"] = "Магазин"
SN["Small Starter Decor Pack"] = "Малый стартовый набор декора"
SN["Spring Blossom Decor Pack"] = "Набор декора «Весенние цветы»"
SN["Spring Blossom Decor Pack 2"] = "Набор декора «Весенние цветы» 2"
...
SN["Twitch drop (Feb 26 to Mar 24)"] = "Twitch Drop (с 26 февраля по 24 марта)"
SN["Twitch drop (June 16 to July 14)"] = "Twitch Drop (с 16 июня по 14 июля)"
...
SN["Zillow for Warcraft Promotion"] = "Промо-акция «Zillow for Warcraft»"

-- Encounters (bosses)
SN["Advisor Melandrus (Court of Stars)"] = "Советник Меландр (Квартал Звезд)"
SN["Avatar of Sethraliss (Temple of Sethraliss)"] = "Аватара Сетралисс (Храм Сетралисс)"
SN["Belo'ren, Child of Al'ar"] = "Бело'рен, дитя Аль'ара"
...
SN["Dazar, The First King (Kings' Rest)"] = "Дазар, первый король (Гробница королей)"
...
SN["Entombed Sentinels (The Venomous Abyss)"] = "Погребенные стражи (Отравленная бездна)"
...
SN["Nek'zali the Soulcoiler (The Venomous Abyss)"] = "Нек'зали Душительница Душ (Отравленная бездна)"
SN["Nymrissa Wavecaller (The Tidebound Grotto)"] = "Нимрисса Волногон (Приливный грот)"
...
SN["Sszorak (The Venomous Abyss)"] = "Ссзорак (Отравленная бездна)"
SN["Teron'gor"] = "Терон'гор"
SN["The Coiled Altar (The Venomous Abyss)"] = "Спиральный алтарь (Отравленная бездна)"
SN["The Darkness"] = "Тьма"
SN["The Lost Explorers (The Venomous Abyss)"] = "Потерявшиеся исследователи (Отравленная бездна)"
SN["The Restless Cabal"] = "Неутомимый конклав"
SN["The Restless Heart"] = "Неупокоенное сердце"
SN["The Twin Fangs (The Venomous Abyss)"] = "Два Клыка (Отравленная бездна)"
SN["Ula'tek (Heroic, The Venomous Abyss)"] = "Ула'тек (героический, Отравленная бездна)"
SN["Ula'tek (Mythic, The Venomous Abyss)"] = "Ула'тек (эпохальный, Отравленная бездна)"
SN["Ula'tek (Raid Finder/Normal, The Venomous Abyss)"] = "Ула'тек (поиск рейда/обычный, Отравленная бездна)"
SN["Ula'tek (The Venomous Abyss)"] = "Ула'тек (Отравленная бездна)"
SN["Vaelgor & Ezzorak"] = "Велгор и Эззорак"
SN["Vanessa VanCleef"] = "Ванесса ван Клиф"
SN["Vashnik the Malignant (The Venomous Abyss)"] = "Вашник Тлетворный (Отравленная бездна)"
...
SN["Vorasius (The Voidspire)"] = "Ворасиус (Шпиль Бездны)"
...
-- Treasures
SN["Crumbling Urn (The Coiled Isle)"] = "Хрупкая урна (Спиральный остров)"
SN["Forgotten Treasure (The Coiled Isle)"] = "Забытое сокровище (Спиральный остров)"
SN["Glimmering Treasure Chest"] = "Сверкающий сундук с сокровищами"
...
SN["Stinking Vessel (The Coiled Isle)"] = "Вонючий сосуд (Спиральный остров)"
SN["Stone Vat (Eversong Woods)"] = "Каменный чан (Леса Вечной Песни)"
SN["Undermine"] = "Нижняя Шахта"
SN["Venomjade Necklace (The Coiled Isle)"] = "Ожерелье из ядовитого нефрита (Спиральный остров)"
SN["Zul'jan's Strongbox (Altar of Fangs)"] = "Сейф Зул'джана (Алтарь Клыков)"

-- Recipe sources (Professions tab)
SN["Construct V'anore"] = "Голем В'аноре"
SN["Jan'sari the Watchful"] = "Джан'сари Внимательная"
SN["Navigator Otoola"] = "Штурман Отула"
SN["Second Mate Sluggs"] = "Вторая помощница Склизз"
SN["Thalassian Recipe in a Bottle"] = "Талассийский рецепт в бутылке"
...
SN["BlizzCon 2026 login reward (September 12-27)"] = "Награда за вход во время BlizzCon 2026 (12–27 сентября)"
SN["World of Warcraft: Forever - Skyborne packs"] = "World of Warcraft: Forever - наборы Skyborne"
SN["Warcraft Forever Collection / Collector's Edition"] = "Warcraft Forever Collection / Коллекционное издание"
