...
L["FILTER_HIDE_SHOP_ITEMS"] = "Shop-Gegenstände ausblenden"
L["FILTER_CURRENCY_HEADER"] = "Währung"
L["FILTER_ALL_CURRENCIES"] = "Alle Währungen"
L["FILTER_NO_CURRENCIES"] = "Keine Währungen gefunden"
L["FILTER_ADDED_PATCH_HEADER"] = "Hinzugefügt in Patch"
L["FILTER_NO_PATCHES"] = "Keine Patchversionen gefunden"
L["FILTERS"] = "Filter"
...
L["DETAILS_ADDED_PATCH"] = "Hinzugefügt in Patch:"
L["DETAILS_DYEABLE"] = "Färbbar"
L["DETAILS_NOT_DYEABLE"] = "Nicht färbbar"
L["DETAILS_SOURCE_UNKNOWN"] = "Unbekannte Quelle"
L["DETAILS_SOURCE_CATEGORY"] = "Kategorie"
L["DETAILS_SOURCE_VENDOR"] = "Händler"
L["DETAILS_SOURCE_ZONE"] = "Zone"
L["DETAILS_SOURCE_COST"] = "Kosten"
...
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER"] = "Silbermond-Berufshändler filtern"
L["OPTIONS_SILVERMOON_PROFESSION_VENDOR_FILTER_TOOLTIP"] = "Nur Silbermond-Berufshändler für Berufe anzeigen, die dieser Charakter erlernt hat"
...
L["OPTIONS_RESET_WINDOW"] = "Fenster zurücksetzen"
L["OPTIONS_RESET_WINDOW_TOOLTIP"] = "Fensterposition und -größe zurücksetzen"
L["OPTIONS_SHOW_WELCOME"] = "Willkommensbildschirm"
L["OPTIONS_SHOW_WELCOME_TOOLTIP"] = "Willkommensbildschirm anzeigen"
L["OPTIONS_SEE_HIDDEN_ITEMS"] = "Ausgeblendete Objekte anzeigen"
L["OPTIONS_SEE_HIDDEN_ITEMS_TOOLTIP"] = "Objekte anzeigen und wiederherstellen, die aus Housing-Codex-Listen ausgeblendet wurden"
L["OPTIONS_COMMAND_HELP"] = "/hc help"
L["OPTIONS_COMMAND_HELP_TOOLTIP_TITLE"] = "Slash-Befehlshilfe"
L["OPTIONS_COMMAND_HELP_TOOLTIP_DESC"] = "Gibt die Slash-Befehlshilfe von Housing Codex im Chat aus. Verwende dies für Fenster- oder Fehlerbehebungsbefehle direkt aus den Einstellungen."
L["SIZE_RESET"] = "Fenstergröße auf Standard zurückgesetzt."

L["OPTIONS_SECTION_KEYBIND"] = "Tastenbelegung"
L["OPTIONS_SECTION_TROUBLESHOOTING"] = "Fehlerbehebung & Debugging"
L["OPTIONS_DISABLE_CUSTOM_FONT"] = "Benutzerdefinierte Schrift deaktivieren"
L["OPTIONS_ENABLE_CUSTOM_FONT"] = "Benutzerdefinierte Schrift aktivieren"
...
L["HELP_ALIASES"] = "Aliase: /hcodex, /housingcodex"
L["HELP_TOGGLE"] = "/hc - Hauptfenster umschalten"
L["HELP_SETTINGS"] = "/hc settings/options - Einstellungen öffnen"
L["HELP_RESET"] = "/hc reset - Fensterposition zurücksetzen"
L["HELP_RETRY"] = "/hc retry/reload - Datenladen erneut versuchen"
...
L["HELP_STATS_RESET"] = "/hc stats reset - Debug-Zähler zurücksetzen"
L["HELP_LOG"] = "|cFFFFD100/hc log|r - Ereignisprotokoll anzeigen (erfordert Debug-Modus)"
L["HELP_LOG_CLEAR"] = "|cFFFFD100/hc log clear|r - Ereignisprotokoll löschen"
L["HELP_FONT"] = "/hc font - Benutzerdefinierte Housing Codex-Schrift umschalten"
L["HELP_WELCOME"] = "/hc welcome - Willkommensbildschirm anzeigen"
L["HELP_WHATSNEW"] = "/hc whatsnew - Neueste Änderungen anzeigen"
L["HELP_INSPECT"] = "/hc inspect <Name> - Einen Dekor-Datensatz zum Debuggen prüfen"
...
L["LDB_POPUP_TOTAL_OWNED"] = "Gesamt (inkl. Duplikate)"
L["LDB_POPUP_TOTAL_ITEMS"] = "Gesamtobjekte"
L["LDB_POPUP_PERCENT"] = "Sammlung %"
L["LDB_TOOLTIP_WISHLIST"] = "Wunschliste"
L["LDB_TOOLTIP_WISHLIST_COUNT"] = "%d Objekte"
L["LDB_TOOLTIP_SHIFT_RIGHT"] = "|cffffffffShift-Rechtsklick|r um Sammelfortschritt anzuzeigen"
...
L["CONTEXT_MENU_HIDE_ITEM"] = "Dieses Objekt ausblenden"
L["CONTEXT_MENU_UNHIDE_ITEM"] = "Dieses Objekt einblenden"
L["HIDDEN_ITEMS_TITLE"] = "Ausgeblendete Objekte"
L["HIDDEN_ITEMS_EMPTY"] = "Keine ausgeblendeten Objekte"
L["HIDDEN_ITEMS_EMPTY_DESC"] = "Rechtsklicke ein Objekt in Housing Codex und wähle Dieses Objekt ausblenden, um es hier hinzuzufügen."
L["HIDDEN_ITEMS_UNHIDE"] = "Einblenden"
L["HIDDEN_ITEMS_CLEAR_ALL"] = "Alle einblenden"
L["HIDDEN_ITEMS_CLEAR_ALL_TOOLTIP"] = "Alle mit Dieses Objekt ausblenden ausgeblendeten Objekte wiederherstellen"
L["HIDDEN_ITEMS_CLEAR_ALL_CONFIRM"] = "Alle %d ausgeblendeten Objekte wieder einblenden?"
L["HIDDEN_ITEMS_HIDE_CONFIRM"] = "\"%s\" ausblenden?"
L["HIDDEN_ITEMS_COUNT"] = "%d ausgeblendet"

--------------------------------------------------------------------------------
-- Vendors Tab
--------------------------------------------------------------------------------
L["VENDORS_SEARCH_PLACEHOLDER"] = "Händler, Zonen, Währungen oder Objekte suchen..."
L["VENDORS_FILTER_ALL"] = "Alle"
L["VENDORS_FILTER_INCOMPLETE"] = "Unvollständig"
L["VENDORS_FILTER_COMPLETE"] = "Abgeschlossen"
L["VENDORS_FILTER_CURRENCY"] = "Währung"
L["VENDORS_FILTER_ALL_CURRENCIES"] = "Alle Währungen"
L["VENDORS_FILTER_NO_CURRENCIES"] = "Keine Währungen gefunden"
...
L["VENDOR_CLASS_HALL_SUFFIX"] = "%s-Klassenhalle"
L["VENDOR_HOUSING_ZONE_SUFFIX"] = "Housing-Zone: %s"
...
L["PROFESSIONS_RECIPE_SOURCE"] = "Rezeptquelle: %s"

--------------------------------------------------------------------------------
-- Treasure Hunt Waypoints
--------------------------------------------------------------------------------
L["TREASURE_HUNT_WAYPOINT_TITLE"] = "Dekor-Schatz"
...
L["PROGRESS_PVP_CATEGORIES"] = "PvP-Kategorien"
...
L["PROGRESS_ALL_DECOR_COLLECTED"] = "Sichtbares Dekor gesammelt"
...
L["PROGRESS_SOURCE_DROPS"] = "Beute"
L["PROGRESS_SOURCE_RENOWN"] = "Ruhm"
L["PROGRESS_SOURCE_PROMOTIONAL"] = "Promo"
L["PROGRESS_LOADING"] = "Fortschrittsdaten werden geladen..."

L["WISHLIST_SEARCH_PLACEHOLDER"] = "Wunschliste durchsuchen..."
L["WISHLIST_NO_SEARCH_RESULTS"] = "Keine Wunschlisten-Objekte passen zur Suche"
L["WISHLIST_NO_SEARCH_RESULTS_DESC"] = "Versuche einen anderen Namen oder lösche die Suche."
L["WISHLIST_GROUP_BY_SOURCE"] = "Nach Quelle gruppieren"
L["WISHLIST_GROUP_OTHER"] = "Andere"
L["WISHLIST_GROUP_HEADER_COUNT"] = "%d gesamt, %d gesammelt"
L["PROGRESS_STAT_WISHLIST"] = "Wunschliste"
L["PROGRESS_STAT_HIDDEN"] = "Ausgeblendet"
L["PROGRESS_BUDGET_HEADER"] = "PARZELLEN-DEKORBUDGET"
L["PROGRESS_BUDGET_INTERIOR"] = "Innenraum"
L["PROGRESS_BUDGET_PLOT"] = "Grundstück"
L["PROGRESS_BUDGET_LAST_UPDATED"] = "Zuletzt aktualisiert: %s"
L["PROGRESS_BUDGET_OUTDOOR"] = "Außenbereich"
L["PROGRESS_BUDGET_EMPTY_HINT"] = "Besuche dieses Grundstück und aktiviere den Hausbearbeitungsmodus draußen und drinnen, um beide Budgetwerte zu erfassen."
L["PROGRESS_BUDGET_REFRESH_BOTH_HINT"] = "Beide Budgetwerte müssen erneut bestätigt werden. Aktiviere bei diesem Haus draußen und drinnen den Hausbearbeitungsmodus."
L["PROGRESS_BUDGET_REFRESH_OUTDOOR_HINT"] = "Das Außenbudget muss erneut bestätigt werden. Aktiviere draußen auf diesem Grundstück den Hausbearbeitungsmodus."
L["PROGRESS_BUDGET_REFRESH_INTERIOR_HINT"] = "Das Innenbudget muss erneut bestätigt werden. Aktiviere in diesem Haus den Hausbearbeitungsmodus."
L["PROGRESS_BUDGET_INDOOR"] = "Innenbereich"
L["PROGRESS_BUDGET_LEVEL"] = "Stufe %d"
L["PROGRESS_BUDGET_LEVEL_UNKNOWN"] = "Stufe --"
L["PROGRESS_BUDGET_TIME_AGO"] = "vor %s"
L["PROGRESS_TIME_MINUTE"] = "%d Minute"
L["PROGRESS_TIME_MINUTES"] = "%d Minuten"
L["PROGRESS_TIME_HOUR"] = "%d Stunde"
L["PROGRESS_TIME_HOURS"] = "%d Stunden"
L["PROGRESS_TIME_DAY"] = "%d Tag"
L["PROGRESS_TIME_DAYS"] = "%d Tage"
L["PROGRESS_HISTORY_HEADER"] = "DEKOR DER LETZTEN %d TAGE"
L["PROGRESS_HISTORY_SUMMARY"] = "+%d in den letzten %d Tagen"
L["PROGRESS_HISTORY_TOOLTIP_TODAY"] = "Heute"
L["PROGRESS_HISTORY_TOOLTIP_DAY_AGO"] = "Vor %d Tag"
L["PROGRESS_HISTORY_TOOLTIP_DAYS_AGO"] = "Vor %d Tagen"
L["PROGRESS_HISTORY_TOOLTIP_GAIN"] = "+%d Dekor gelernt"
L["PROGRESS_HISTORY_TOOLTIP_EMPTY"] = "Kein neues Dekor erfasst"
L["PROGRESS_HISTORY_TOOLTIP_START"] = "Tagesstart: %s"
L["PROGRESS_HISTORY_TOOLTIP_TOTAL"] = "Erfasste Gesamtzahl: %s"
L["PROGRESS_HISTORY_TOOLTIP_NO_SNAPSHOT"] = "Kein Schnappschuss für diesen Tag gespeichert"
L["PROGRESS_HISTORY_TOOLTIP_HINT"] = "Aktualisiert sich, wenn sich deine gesammelte Dekoranzahl ändert."
L["PROGRESS_ACHIEVEMENT_CATEGORIES"] = "Erfolgskategorien"
L["PROGRESS_DROP_CATEGORIES"] = "Beutekategorien"
--------------------------------------------------------------------------------
...
L["WELCOME_OPEN_INSTRUCTION"] = "Du kannst das Addon jederzeit mit %s öffnen oder in %s eine eigene Tastenbelegung festlegen."
...
L["WELCOME_F3_DESC"] = "Sieh, wo du fehlendes Dekor erhältst: Quests, Erfolge, Händler, Beute, Berufe, Ruhm und PvP."
...
-- Endeavors Panel
--------------------------------------------------------------------------------
L["ENDEAVORS_TITLE"] = "Unterfangen"
L["ENDEAVORS_BAR_ABBREV"] = "U"
L["ENDEAVORS_OPTIONS"] = "Unterfangen-Optionen"
L["ENDEAVORS_OPTIONS_TOOLTIP"] = "Das Unterfangen-Overlaypanel konfigurieren"
...
L["ENDEAVORS_OPT_SECTION_ENDEAVOR"] = "Unterfangen-Fortschritt"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR"] = "Unterfangen-Fortschrittsleiste anzeigen"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TIP"] = "Fortschrittsleiste des Nachbarschaftsunterfangens anzeigen"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT"] = "Text auf Unterfangen-Leiste anzeigen"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_TEXT_TIP"] = "Zahlenwerte auf der Unterfangen-Fortschrittsleiste anzeigen"
...
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT"] = "Prozentwert auf Unterfangen-Leiste anzeigen"
L["ENDEAVORS_OPT_SHOW_ENDEAVOR_PCT_TIP"] = "Prozentwert auf der Unterfangen-Fortschrittsleiste anzeigen"
...
L["ENDEAVORS_XP_TOOLTIP_AVAILABLE"] = "Verfügbar: %s"
L["ENDEAVORS_XP_TOOLTIP_CLICK"] = "Klicken, um das Housing-Dashboard zu öffnen"
L["ENDEAVORS_TOOLTIP_CLICK"] = "Klicken, um Unterfangen zu öffnen"
L["ENDEAVORS_PCT_DONE"] = "FERTIG"
L["OPTIONS_SECTION_ENDEAVORS"] = "Unterfangen"
L["OPTIONS_ENDEAVORS_ENABLED"] = "Unterfangen-Panel aktivieren"
L["OPTIONS_ENDEAVORS_ENABLED_TOOLTIP"] = "Das Unterfangen-Minipanel anzeigen, wenn du dich in einer Nachbarschaft mit Haus befindest"
L["ENDEAVORS_OPT_ENABLED"] = "Unterfangen-Panel aktivieren"
L["ENDEAVORS_OPT_ENABLED_TIP"] = "Das Unterfangen-Panel anzeigen, wenn du dich in einer Nachbarschaft mit Haus befindest"
...
L["ENDEAVORS_OPT_SCALE_TIP"] = "Die Größe des Unterfangen-Panels ändern"
...
--------------------------------------------------------------------------------
L["TAB_RENOWN"] = "RUHM"
L["TAB_RENOWN_DESC"] = "Ruhmquellen für Housing-Dekorobjekte"
...
SN["Arcanostorage Sphere"] = "Arkanospeichersphäre"
SN["BlizzCon 2026 Twitch / YouTube reward (4 hours; claim to unlock extra copies)"] = "BlizzCon-2026-Twitch-/YouTube-Belohnung (4 Stunden; zum Freischalten weiterer Kopien einlösen)"
SN["BlizzCon 2026 in-game goodies"] = "BlizzCon-2026-Ingame-Extras"
SN["Brewfest (seasonal event)"] = "Braufest (saisonales Event)"
SN["Darkshore Rares"] = "Seltene Gegner an der Dunkelküste"
SN["Delve Treasure Chests"] = "Schatztruhen in Tiefen"
SN["Delves"] = "Tiefen"
SN["Diablo 2 expansion bonus"] = "Diablo-2-Erweiterungsbonus"
SN["Diablo 4 pre-order"] = "Diablo-4-Vorbestellung"
SN["Fanta x Warcraft collab"] = "Fanta- und Warcraft-Kollaboration"
SN["Highmountain Tauren Paragon Chest"] = "Paragontruhe der Tauren von Hochberg"
SN["In-game shop"] = "Shop im Spiel"
SN["Large Starter Decor Pack"] = "Großes Starterdekorationspaket"
SN["Login Reward (Midnight)"] = "Login-Belohnung (Midnight)"
SN["Lush Garden Decor Pack"] = "Dekorationspaket des üppigen Gartens"
SN["Lush Garden Decor Pack 2"] = "Dekorationspaket 2 des üppigen Gartens"
SN["Midnight Delves"] = "Midnight-Tiefen"
SN["Pepe (neighborhood billboard)"] = "Pepe (Werbetafel der Nachbarschaft)"
SN["Pinterest London IRL quest (March 21)"] = "Pinterest-Quest in London (21. März)"
SN["Ral'kala"] = "Ral'kala"
SN["Roofus charity pet (The Roofus Pack)"] = "Wohltätigkeitshaustier Bob (Das Bob-Paket)"
SN["Rotmire"] = "Rottmoor"
...
SN["Shop"] = "Shop"
SN["Small Starter Decor Pack"] = "Kleines Starterdekorationspaket"
SN["Spring Blossom Decor Pack"] = "Dekorationspaket der Frühlingsblüten"
SN["Spring Blossom Decor Pack 2"] = "Dekorationspaket 2 der Frühlingsblüten"
...
SN["Twitch drop (June 16 to July 14)"] = "Twitch-Drop (16. Juni bis 14. Juli)"
...
SN["Zillow for Warcraft Promotion"] = "Zillow-for-Warcraft-Aktion"

-- Encounters (bosses)
SN["Advisor Melandrus (Court of Stars)"] = "Berater Melandrus (Hof der Sterne)"
SN["Avatar of Sethraliss (Temple of Sethraliss)"] = "Avatar von Sethraliss (Der Tempel von Sethraliss)"
...
SN["Crown of the Cosmos (The Voidspire)"] = "Krone des Kosmos (Die Leerenspitze)"
SN["Dargrul the Underking"] = "Dargrul der Unterkönig"
SN["Dazar, The First King (Kings' Rest)"] = "Dazar, der erste König (Die Königsruh)"
...
SN["Entombed Sentinels (The Venomous Abyss)"] = "Eingeschlossene Wächter (Der Giftige Abgrund)"
...
SN["Nek'zali the Soulcoiler (The Venomous Abyss)"] = "Nek'zali die Seelenwinderin (Der Giftige Abgrund)"
SN["Nymrissa Wavecaller (The Tidebound Grotto)"] = "Nymrissa Wellenrufer (Die Gezeitengebundene Grotte)"
...
SN["Sszorak (The Venomous Abyss)"] = "Sszorak (Der Giftige Abgrund)"
SN["Teron'gor"] = "Teron'gor"
SN["The Coiled Altar (The Venomous Abyss)"] = "Der Gewundene Altar (Der Giftige Abgrund)"
SN["The Darkness"] = "Die Dunkelheit"
SN["The Lost Explorers (The Venomous Abyss)"] = "Die verirrten Entdecker (Der Giftige Abgrund)"
SN["The Restless Cabal"] = "Die rastlose Kabale"
SN["The Restless Heart"] = "Das rastlose Herz"
SN["The Twin Fangs (The Venomous Abyss)"] = "Die Zwillingsfänge (Der Giftige Abgrund)"
SN["Ula'tek (Heroic, The Venomous Abyss)"] = "Ula'tek (Heroisch, Der Giftige Abgrund)"
SN["Ula'tek (Mythic, The Venomous Abyss)"] = "Ula'tek (Mythisch, Der Giftige Abgrund)"
SN["Ula'tek (Raid Finder/Normal, The Venomous Abyss)"] = "Ula'tek (Schlachtzugsbrowser/Normal, Der Giftige Abgrund)"
SN["Ula'tek (The Venomous Abyss)"] = "Ula'tek (Der Giftige Abgrund)"
SN["Vaelgor & Ezzorak"] = "Vaelgor & Ezzorak"
SN["Vanessa VanCleef"] = "Vanessa VanCleef"
SN["Vashnik the Malignant (The Venomous Abyss)"] = "Vashnik der Bösartige (Der Giftige Abgrund)"
...
-- Treasures
SN["Crumbling Urn (The Coiled Isle)"] = "Bröckelnde Urne (Die Gewundene Insel)"
SN["Forgotten Treasure (The Coiled Isle)"] = "Vergessener Schatz (Die Gewundene Insel)"
SN["Glimmering Treasure Chest"] = "Glitzernde Schatztruhe"
SN["Golden Cloud Serpent Treasure Chest (Jade Forest)"] = "Schatztruhe der goldenen Wolkenschlange (Jadewald)"
SN["Malignant Chest (Voidstorm)"] = "Bösartige Truhe (Leerensturm)"
SN["Stellar Stash (Slayer's Rise)"] = "Sternenvorrat (Slayer's Rise)"
SN["Stinking Vessel (The Coiled Isle)"] = "Stinkendes Gefäß (Die Gewundene Insel)"
SN["Stone Vat (Eversong Woods)"] = "Steinbottich (Immersangwald)"
SN["Undermine"] = "Lorenhall"
SN["Venomjade Necklace (The Coiled Isle)"] = "Giftjadekette (Die Gewundene Insel)"
SN["Zul'jan's Strongbox (Altar of Fangs)"] = "Zul'jans Schließkassette (Der Altar der Fänge)"

-- Recipe sources (Professions tab)
SN["Construct V'anore"] = "Konstrukt V'anore"
SN["Jan'sari the Watchful"] = "Jan'sari die Wachsame"
SN["Navigator Otoola"] = "Navigatorin Otoola"
SN["Second Mate Sluggs"] = "Zweiter Maat Schneckler"
SN["Thalassian Recipe in a Bottle"] = "Thalassisches Rezept in der Flasche"
...
SN["BlizzCon 2026 login reward (September 12-27)"] = "BlizzCon-2026-Loginbelohnung (12.–27. September)"
SN["World of Warcraft: Forever - Skyborne packs"] = "World of Warcraft: Forever - Skyborne-Pakete"
